...
__asm ADDR_RM_ShH_F27_Lib(void)
{
	dcb 27//实时Fn
	dcb 3//4//通信标识个数
	dcb 0//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
__asm ADDR_RM_ShH_F33_Lib(void)
{
	dcb 33//实时Fn
	dcb 0//通信标识个数
...
__asm ADDR_RM_ShH_F35_Lib(void)
{
	dcb 35//实时Fn
	dcb 0//通信标识个数
	dcb 1//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
__asm ADDR_RM_ShH_F129_Lib(void)
{
	dcb 129//实时Fn
	dcb 1//通信标识个数
	dcb 1//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
__asm ADDR_RM_ShH_F137_Lib(void)
{
	dcb 137//实时Fn
	dcb 1//通信标识个数
	dcb 1//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
//__asm ADDR_RM_ShH_F145_Lib(void)
//{
//	dcb 145//实时Fn
//	dcb 1//通信标识个数
//	dcb 1//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
//F162 电能表日历时钟
__asm ADDR_RM_ShH_F162_Lib(void)
{
	dcb 162//实时Fn
	dcb 1//通信标识个数
	dcb 0//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
//F166 电能表参数修改次数及时间
__asm ADDR_RM_ShH_F166_Lib(void)
{
	dcb 166//实时Fn
	dcb 2//通信标识个数
	dcb 0//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
//__asm ADDR_RM_ShH_FE1_Lib(void)
//{
//	dcb 0xE1//实时Fn
//	dcb 4//通信标识个数
//	dcb 0//数据头,0=终端抄表时间,1=终端抄表时间+费率数
...
__asm ADDR_RM_ShH_FE3_Lib(void)
{
	dcb 0xE3//实时Fn
	dcb 1//通信标识个数
	dcb 1//数据头,0=终端抄表时间,1=终端抄表时间+费率数
