...
//F1上报从节点信息
				case 1://F1上报从节点信息
					...
					for(i=0;i<n;i++)
					{
						...
						//AutoSetAFN04F10(PORTn,MeterAddr,Protocol,0xeeeeeeeeeeee,0,Phase);//自动设置AFN04F10的电能表配置
...
//F4上报从节点信息及设备类型
				...
				//送检模式
						...
						case 5://瑞斯康
							...
							if(i==1)
							{//上报电能表
								//AutoSetAFN04F10(PORTn,CollectorAddr,Protocol,0xeeeeeeeeeeee,0,Phase);//自动设置AFN04F10的电能表配置
