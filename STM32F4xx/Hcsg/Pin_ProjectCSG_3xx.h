...
// 1(B)
#define PIN_URTC   		(1<<8)+0		// 时钟电池 3.6V 电压检测
#define PIN_UBACKUP   		(1<<8)+1		// 后备电池 4.8V 电压检测
...
#define PIN_CT_A_CHK		(5<<8)+9		// PIN_NEXTI
#define PIN_CT_B_CHK     	(5<<8)+10		// PIN_NEXTD
...
// 10(K)
#define PIN_CH_CTL1     	(10<<8)+0
#define PIN_CH_CTL0     	(10<<8)+1
