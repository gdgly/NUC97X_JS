...
#ifdef LINUX
//1M ISRAM
#define ADDR_SPI_MAP     ADDR_ERAM_LINUX+0x00100000
#define LEN_SPI_MAP     0x00080000
//512K IEEPROM(SPIFLASH) 映射
#define ADDR_NAND_MAP     ADDR_SPI_MAP+LEN_SPI_MAP
#define LEN_NAND_MAP     0x00280000
// 2.5M NAND_FLASH 映射

#define ADDR_ETHMAC     ADDR_NAND_MAP+LEN_NAND_MAP//以太网MAC地址
//6byte MACADDR0
//6byte MACADDR1
//2byte 
#define ADDR_REG_SYS_RSTSTS     ADDR_ETHMAC+16
//4byte 上电时读取的REG_SYS_RSTSTS值
#define ADDR_ERAM_START     (ADDR_REG_SYS_RSTSTS+4)
#endif
