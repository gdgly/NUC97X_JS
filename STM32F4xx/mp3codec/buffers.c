 ...
 *
 * Roger: Since the memory is allocated dynamically from heap, you must config the 
 * the heap size manually in startup_LPC17xx.s. For buffer.c, you need to allocate
 * 23824(0x5D10) bytes for these variables: FrameHeader, SideInfo, ..., SubbandInfo.
 **************************************************************************************/

//#include "hlxclib/stdlib.h"		/* for malloc, free */ 
#include <stdlib.h> // Roger
