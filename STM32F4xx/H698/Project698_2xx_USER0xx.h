...
#define Meter_UpDataInit    3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始
#define Terminal_UpDataInit 0//3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化,7=参数初始化(档案和nand文件数据转移到新地址)
...
#endif
#ifdef IC_NUC9xx
#define SVER     0x120//软件版本号x.xx:电科院测试为V1.00更新到V1.10
#define SVDATE   0x191216//软件发行日期:年月日
	#ifndef LINUX
...
#define NUMmax_601C     32//最大上报方案数(此数影响最大文件个数)
...
#define FileUserDIR          "/J000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_J000_000_V41.*"
	#define FileUser_MS        "MS698_J000_000_V41.*"
	#define FileUser_OS        "OS698_J000_000_V41.*"
	#define FileUser_Meter     "Meter698_J000_000_V41.*"
	#define FileUser_Terminal  "Terminal698_J000_000_V41.*"
	#define FileUser_Menu      "Menu698_J000_000_V41.*"
	#define FileUser_Font      "Font_J000_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_J000_000_V41.*"
	#define FileUser_PLC_50    "PLC_J000_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_J000_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_J000_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_J000_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_J000_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_J000_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_J000_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_J000_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_J000_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_J000_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_J000_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_J000_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_J000_000_V41.zip"
	#define FileFTP_MS        "MS698_J000_000_V41.zip"
	#define FileFTP_OS        "OS698_J000_000_V41.zip"
	#define FileFTP_Meter     "Meter698_J000_000_V41.zip"
	#define FileFTP_Terminal  "Terminal698_J000_000_V41.zip"
	#define FileFTP_Menu      "Menu698_J000_000_V41.zip"
	#define FileFTP_Font      "Font_J000_000_V41.zip"
	#define FileFTP_MODULE    "Module698_J000_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_J000_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_000_V41_SR.zip"
#endif
...
#define FileUserDIR          "/J000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_J000_000_V50.zip"
	#define FileUser_MS        "MS698N_J000_000_V50.zip"
	#define FileUser_OS        "OS698N_J000_000_V50.zip"
	#define FileUser_Meter     "Meter698N_J000_000_V50.zip"
	#define FileUser_Terminal  "Terminal698N_J000_000_V50.zip"
	#define FileUser_Menu      "Menu698N_J000_000_V50.zip"
	#define FileUser_Font      "FontN_J000_000_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_J000_000_V50.zip"
	#define FileUser_PLC_50    "PLC_J000_000_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_J000_000_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_J000_000_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_J000_000_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_J000_000_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_J000_000_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_J000_000_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_J000_000_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_J000_000_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_J000_000_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_J000_000_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_J000_000_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_J000_000_V50.zip"
	#define FileFTP_MS        "MS698N_J000_000_V50.zip"
	#define FileFTP_OS        "OS698N_J000_000_V50.zip"
	#define FileFTP_Meter     "Meter698N_J000_000_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_J000_000_V50.zip"
	#define FileFTP_Menu      "Menu698N_J000_000_V50.zip"
	#define FileFTP_Font      "FontN_J000_000_V50.zip"
	#define FileFTP_MODULE    "Module698N_J000_000_V50.zip"
	#define FileFTP_PLC_50    "PLC_J000_000_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_000_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_000_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_000_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_000_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_000_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_000_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_000_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_000_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_000_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_000_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_000_V50_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 20000imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_J000_100_V50.zip"
	#define FileUser_MS        "MS698N_J000_100_V50.zip"
	#define FileUser_OS        "OS698N_J000_100_V50.zip"
	#define FileUser_Meter     "Meter698N_J000_100_V50.zip"
	#define FileUser_Terminal  "Terminal698N_J000_100_V50.zip"
	#define FileUser_Menu      "Menu698N_J000_100_V50.zip"
	#define FileUser_Font      "FontN_J000_100_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_J000_100_V50.zip"
	#define FileUser_PLC_50    "PLC_J000_100_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_J000_100_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_J000_100_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_J000_100_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_J000_100_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_J000_100_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_J000_100_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_J000_100_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_J000_100_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_J000_100_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_J000_100_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_J000_100_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_J000_100_V50.zip"
	#define FileFTP_MS        "MS698N_J000_100_V50.zip"
	#define FileFTP_OS        "OS698N_J000_100_V50.zip"
	#define FileFTP_Meter     "Meter698N_J000_100_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_J000_100_V50.zip"
	#define FileFTP_Menu      "Menu698N_J000_100_V50.zip"
	#define FileFTP_Font      "FontN_J000_100_V50.zip"
	#define FileFTP_MODULE    "Module698N_J000_100_V50.zip"
	#define FileFTP_PLC_50    "PLC_J000_100_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_100_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_100_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_100_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_100_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_100_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_100_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_100_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_100_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_100_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_100_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_100_V50_SR.zip"
#endif

#if MeterSpec==19//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_J000_1900_V50.zip"
	#define FileUser_MS        "MS698N_J000_1900_V50.zip"
	#define FileUser_OS        "OS698N_J000_1900_V50.zip"
	#define FileUser_Meter     "Meter698N_J000_1900_V50.zip"
	#define FileUser_Terminal  "Terminal698N_J000_1900_V50.zip"
	#define FileUser_Menu      "Menu698N_J000_1900_V50.zip"
	#define FileUser_Font      "FontN_J000_1900_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_J000_1900_V50.zip"
	#define FileUser_PLC_50    "PLC_J000_1900_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_J000_1900_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_J000_1900_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_J000_1900_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_J000_1900_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_J000_1900_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_J000_1900_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_J000_1900_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_J000_1900_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_J000_1900_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_J000_1900_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_J000_1900_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_J000_1900_V50.zip"
	#define FileFTP_MS        "MS698N_J000_1900_V50.zip"
	#define FileFTP_OS        "OS698N_J000_1900_V50.zip"
	#define FileFTP_Meter     "Meter698N_J000_1900_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_J000_1900_V50.zip"
	#define FileFTP_Menu      "Menu698N_J000_1900_V50.zip"
	#define FileFTP_Font      "FontN_J000_1900_V50.zip"
	#define FileFTP_MODULE    "Module698N_J000_1900_V50.zip"
	#define FileFTP_PLC_50    "PLC_J000_1900_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_1900_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_1900_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_1900_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_1900_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_1900_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_1900_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_1900_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_1900_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_1900_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_1900_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_1900_V50_SR.zip"
#endif
#endif
//硬件版本5.00结束----------------------------------------------------------------------------------
...
#ifdef  NAND_2G
#define NAND_BLOCK_COUNT     2048//NANDFLASH总有块数(每块128K,每页2048Byte)
#define NAND_FILE_BLOCK_COUNT     256//32MB linux
#define NAND_REPLACE_BLOCK_COUNT     ((NAND_BLOCK_COUNT/1024)*32)//NANDFLASH用于替换的块数(紧接文件系统后)
#endif
#ifdef  NAND_4G
#define NAND_BLOCK_COUNT     4096//NANDFLASH总有块数(每块128K,每页2048Byte)
...
#define FileUserDIR          "/J000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_J000_000_V51.zip"
	#define FileUser_MS        "MS698N_J000_000_V51.zip"
	#define FileUser_OS        "OS698N_J000_000_V51.zip"
	#define FileUser_Meter     "Meter698N_J000_000_V51.zip"
	#define FileUser_Terminal  "Terminal698N_J000_000_V51.zip"
	#define FileUser_Menu      "Menu698N_J000_000_V51.zip"
	#define FileUser_Font      "FontN_J000_000_V51.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_J000_000_V51.zip"
	#define FileUser_PLC_50    "PLC_J000_000_V51_50.zip"
	#define FileUser_PLC_TC    "PLC_J000_000_V51_TC.zip"
	#define FileUser_PLC_ES    "PLC_J000_000_V51_ES.zip"
	#define FileUser_PLC_CX    "PLC_J000_000_V51_CX.zip"
	#define FileUser_PLC_01    "PLC_J000_000_V51_01.zip"
	#define FileUser_PLC_LH    "PLC_J000_000_V51_LH.zip"
	#define FileUser_PLC_NX    "PLC_J000_000_V51_NX.zip"
	#define FileUser_PLC_QL    "PLC_J000_000_V51_QL.zip"
	#define FileUser_PLC_MX    "PLC_J000_000_V51_MX.zip"
	#define FileUser_PLC_FC    "PLC_J000_000_V51_FC.zip"
	#define FileUser_PLC_NW    "PLC_J000_000_V51_NW.zip"
	#define FileUser_PLC_SR    "PLC_J000_000_V51_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_J000_000_V51.zip"
	#define FileFTP_MS        "MS698N_J000_000_V51.zip"
	#define FileFTP_OS        "OS698N_J000_000_V51.zip"
	#define FileFTP_Meter     "Meter698N_J000_000_V51.zip"
	#define FileFTP_Terminal  "Terminal698N_J000_000_V51.zip"
	#define FileFTP_Menu      "Menu698N_J000_000_V51.zip"
	#define FileFTP_Font      "FontN_J000_000_V51.zip"
	#define FileFTP_MODULE    "Module698N_J000_000_V51.zip"
	#define FileFTP_PLC_50    "PLC_J000_000_V51_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_000_V51_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_000_V51_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_000_V51_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_000_V51_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_000_V51_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_000_V51_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_000_V51_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_000_V51_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_000_V51_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_000_V51_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_000_V51_SR.zip"
#endif

#if MeterSpec==19//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_J000_1900_V51.zip"
	#define FileUser_MS        "MS698N_J000_1900_V51.zip"
	#define FileUser_OS        "OS698N_J000_1900_V51.zip"
	#define FileUser_Meter     "Meter698N_J000_1900_V51.zip"
	#define FileUser_Terminal  "Terminal698N_J000_1900_V51.zip"
	#define FileUser_Menu      "Menu698N_J000_1900_V51.zip"
	#define FileUser_Font      "FontN_J000_1900_V51.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_J000_1900_V51.zip"
	#define FileUser_PLC_50    "PLC_J000_1900_V51_50.zip"
	#define FileUser_PLC_TC    "PLC_J000_1900_V51_TC.zip"
	#define FileUser_PLC_ES    "PLC_J000_1900_V51_ES.zip"
	#define FileUser_PLC_CX    "PLC_J000_1900_V51_CX.zip"
	#define FileUser_PLC_01    "PLC_J000_1900_V51_01.zip"
	#define FileUser_PLC_LH    "PLC_J000_1900_V51_LH.zip"
	#define FileUser_PLC_NX    "PLC_J000_1900_V51_NX.zip"
	#define FileUser_PLC_QL    "PLC_J000_1900_V51_QL.zip"
	#define FileUser_PLC_MX    "PLC_J000_1900_V51_MX.zip"
	#define FileUser_PLC_FC    "PLC_J000_1900_V51_FC.zip"
	#define FileUser_PLC_NW    "PLC_J000_1900_V51_NW.zip"
	#define FileUser_PLC_SR    "PLC_J000_1900_V51_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_J000_1900_V51.zip"
	#define FileFTP_MS        "MS698N_J000_1900_V51.zip"
	#define FileFTP_OS        "OS698N_J000_1900_V51.zip"
	#define FileFTP_Meter     "Meter698N_J000_1900_V51.zip"
	#define FileFTP_Terminal  "Terminal698N_J000_1900_V51.zip"
	#define FileFTP_Menu      "Menu698N_J000_1900_V51.zip"
	#define FileFTP_Font      "FontN_J000_1900_V51.zip"
	#define FileFTP_MODULE    "Module698N_J000_1900_V51.zip"
	#define FileFTP_PLC_50    "PLC_J000_1900_V51_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_1900_V51_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_1900_V51_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_1900_V51_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_1900_V51_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_1900_V51_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_1900_V51_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_1900_V51_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_1900_V51_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_1900_V51_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_1900_V51_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_1900_V51_SR.zip"
#endif
#endif
//硬件版本5.10结束----------------------------------------------------------------------------------
