...
#define Terminal_UpDataInit  3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化,7=参数初始化(档案和nand文件数据转移到新地址)
...
#define SVDATE     0x191206//软件发行日期:年月日
...
#ifdef IC_NUC9xx
#define SVER       0x100//软件版本号:电科院测试为V1.0更新到V1.1
#define SVDATE     0x190403//软件发行日期:年月日
	#ifndef LINUX
...
#define NUM_RMmax       			  64//1024//最大抄表数
#define NUM_RMLISTmax    				0//载波路由主动抄表时用的最大抄表能缓存个数(抄表计数、已抄数据填入等)
#define RM_HPLC_Concurrency     0//0=否,1=是;宽带载波集中器主动并发抄表
	#if (NUM_RMmax*8)>(128*1024)
		#error //记录文件的地址和数据块长度列表区,列表区长度固定8*NUM_RMmax byte通常会1次读到ADDR_128KDATABUFF抄表标志判断用
	#endif
#define RMTASKmax        			128//最大任务数
...
#define RMSOMETASK   				  0//1//0=否,1=是;同类抄表任务归为同个任务抄表,不重启路由
...
#define EnRS485AutoSearchMeter    1//0=否,1=是;允许RS485口自动搜表
...
#define NUMmax_601C     64//最大上报方案数(此数影响文件管理的最大文件个数)
#define NUMmax_Event    15//最大事件记录数
#define NUMmax_Event3106RM     4//停/上电事件最大抄表个数
#define NUMmax_SWITCHIN    		 3//2//最大开关量输入路数(门接点)(<=8)
...
#define RM_SECURITY_MeterNo     1//0//0=否,1=是;DL698安全模式抄表时先抄读电表表号 或 ESAM序列号
#define RM_SECURITY_MeterNo_OAD 0x40020200//DL698安全模式抄表时用于先抄读的OAD,电能表表号=0x40020200,电能表ESAM序列号=0xF1000200
#define RM_SECURITY_CompMAC     1//0//0=否,1=是,安全模式抄表时进行MAC校验码比较
#define CurveTaskTImin   			  0//(60*60)//载波口曲线抄表任务执行频率最小值(秒)
#define CurveTaskTImax     			(24*60*60)//(24*60*60)//载波口曲线抄表任务执行频率最大值(秒),此值决定按采集方案采集间隔时间可向前补抄的曲线点数
...
#define GPRS_ENET_REPORT           1//GPRS/ENET主动上报:0=上报分开,1=上报合并
...
#define LEN_UART5TxMax     0//UART5发送缓冲预留的最大长度(注:确保LEN_UART5Tx<=LEN_UART5TxMax)
...
#define IC_UC1698     0//0=没,1=有(点阵显示)
#define IC_ST75161     1//0=没,1=有(点阵显示)
...
//用户目录全名
#define FileUserDIR          "/K000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1500_000_V4.*"
	#define FileUser_MS        "MS698_K1500_000_V4.*"
	#define FileUser_OS        "OS698_K1500_000_V4.*"
	#define FileUser_Meter     "Meter698_K1500_000_V4.*"
	#define FileUser_Terminal  "Terminal698_K1500_000_V4.*"
	#define FileUser_Menu      "Menu698_K1500_000_V4.*"
	#define FileUser_Font      "Font_K1500_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1500_000_V4.*"
	#define FileUser_PLC_50    "PLC_K1500_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K1500_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K1500_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K1500_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K1500_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K1500_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K1500_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K1500_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K1500_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K1500_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K1500_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K1500_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1500_000_V4.zip"
	#define FileFTP_MS        "MS698_K1500_000_V4.zip"
	#define FileFTP_OS        "OS698_K1500_000_V4.zip"
	#define FileFTP_Meter     "Meter698_K1500_000_V4.zip"
	#define FileFTP_Terminal  "Terminal698_K1500_000_V4.zip"
	#define FileFTP_Menu      "Menu698_K1500_000_V4.zip"
	#define FileFTP_Font      "Font_K1500_000_V4.zip"
	#define FileFTP_MODULE    "Module698_K1500_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_K1500_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_000_V4_SR.zip"
#endif

#if (MeterSpec==16)||(MeterSpec==17)||(MeterSpec==18)
	#define FileUser_PACK      "PACK698_J000_000_V4.*"
	#define FileUser_MS        "MS698_J000_000_V4.*"
	#define FileUser_OS        "OS698_J000_000_V4.*"
	#define FileUser_Meter     "Meter698_J000_000_V4.*"
	#define FileUser_Terminal  "Terminal698_J000_000_V4.*"
	#define FileUser_Menu      "Menu698_J000_000_V4.*"
	#define FileUser_Font      "Font_J000_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_J000_000_V4.*"
	#define FileUser_PLC_50    "PLC_J000_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_J000_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_J000_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_J000_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_J000_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_J000_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_J000_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_J000_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_J000_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_J000_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_J000_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_J000_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_J000_000_V4.zip"
	#define FileFTP_MS        "MS698_J000_000_V4.zip"
	#define FileFTP_OS        "OS698_J000_000_V4.zip"
	#define FileFTP_Meter     "Meter698_J000_000_V4.zip"
	#define FileFTP_Terminal  "Terminal698_J000_000_V4.zip"
	#define FileFTP_Menu      "Menu698_J000_000_V4.zip"
	#define FileFTP_Font      "Font_J000_000_V4.zip"
	#define FileFTP_MODULE    "Module698_J000_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_J000_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_J000_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J000_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J000_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_J000_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_J000_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J000_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J000_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J000_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J000_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J000_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J000_000_V4_SR.zip"
#endif
...
#define FileUserDIR          "/K000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1500_000_V41.*"
	#define FileUser_MS        "MS698_K1500_000_V41.*"
	#define FileUser_OS        "OS698_K1500_000_V41.*"
	#define FileUser_Meter     "Meter698_K1500_000_V41.*"
	#define FileUser_Terminal  "Terminal698_K1500_000_V41.*"
	#define FileUser_Menu      "Menu698_K1500_000_V41.*"
	#define FileUser_Font      "Font_K1500_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1500_000_V41.*"
	#define FileUser_PLC_50    "PLC_K1500_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K1500_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K1500_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K1500_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K1500_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K1500_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K1500_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K1500_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K1500_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K1500_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K1500_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K1500_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1500_000_V41.zip"
	#define FileFTP_MS        "MS698_K1500_000_V41.zip"
	#define FileFTP_OS        "OS698_K1500_000_V41.zip"
	#define FileFTP_Meter     "Meter698_K1500_000_V41.zip"
	#define FileFTP_Terminal  "Terminal698_K1500_000_V41.zip"
	#define FileFTP_Menu      "Menu698_K1500_000_V41.zip"
	#define FileFTP_Font      "Font_K1500_000_V41.zip"
	#define FileFTP_MODULE    "Module698_K1500_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_K1500_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_000_V41_SR.zip"
#endif
#endif//#if(HVER==0x410)//硬件版本号4.10

#if(HVER==0x420)//硬件版本号4.20
#define IC_STM32F42x     1//0=没,1=有
#define IC_STM32F46x     0//0=没,1=有
#define IC_NUC972     0//0=没,1=有
#define IC_NUC975     0//0=没,1=有
...
//用户目录全名
#define FileUserDIR          "/K1500"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1500_000_V42.*"
	#define FileUser_MS        "MS698_K1500_000_V42.*"
	#define FileUser_OS        "OS698_K1500_000_V42.*"
	#define FileUser_Meter     "Meter698_K1500_000_V42.*"
	#define FileUser_Terminal  "Terminal698_K1500_000_V42.*"
	#define FileUser_Menu      "Menu698_K1500_000_V42.*"
	#define FileUser_Font      "Font_K1500_000_V42.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1500_000_V42.*"
	#define FileUser_PLC_50    "PLC_K1500_000_V42_50.*"
	#define FileUser_PLC_TC    "PLC_K1500_000_V42_TC.*"
	#define FileUser_PLC_ES    "PLC_K1500_000_V42_ES.*"
	#define FileUser_PLC_CX    "PLC_K1500_000_V42_CX.*"
	#define FileUser_PLC_01    "PLC_K1500_000_V42_01.*"
	#define FileUser_PLC_LH    "PLC_K1500_000_V42_LH.*"
	#define FileUser_PLC_NX    "PLC_K1500_000_V42_NX.*"
	#define FileUser_PLC_QL    "PLC_K1500_000_V42_QL.*"
	#define FileUser_PLC_MX    "PLC_K1500_000_V42_MX.*"
	#define FileUser_PLC_FC    "PLC_K1500_000_V42_FC.*"
	#define FileUser_PLC_NW    "PLC_K1500_000_V42_NW.*"
	#define FileUser_PLC_SR    "PLC_K1500_000_V42_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1500_000_V42.zip"
	#define FileFTP_MS        "MS698_K1500_000_V42.zip"
	#define FileFTP_OS        "OS698_K1500_000_V42.zip"
	#define FileFTP_Meter     "Meter698_K1500_000_V42.zip"
	#define FileFTP_Terminal  "Terminal698_K1500_000_V42.zip"
	#define FileFTP_Menu      "Menu698_K1500_000_V42.zip"
	#define FileFTP_Font      "Font_K1500_000_V42.zip"
	#define FileFTP_MODULE    "Module698_K1500_000_V42.zip"
	#define FileFTP_PLC_50    "PLC_K1500_000_V42_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_000_V42_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_000_V42_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_000_V42_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_000_V42_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_000_V42_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_000_V42_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_000_V42_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_000_V42_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_000_V42_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_000_V42_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_000_V42_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=1 0.5S 3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1500_100_V42.*"
	#define FileUser_MS        "MS698_K1500_100_V42.*"
	#define FileUser_OS        "OS698_K1500_100_V42.*"
	#define FileUser_Meter     "Meter698_K1500_100_V42.*"
	#define FileUser_Terminal  "Terminal698_K1500_100_V42.*"
	#define FileUser_Menu      "Menu698_K1500_100_V42.*"
	#define FileUser_Font      "Font_K1500_100_V42.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1500_100_V42.*"
	#define FileUser_PLC_50    "PLC_K1500_100_V42_50.*"
	#define FileUser_PLC_TC    "PLC_K1500_100_V42_TC.*"
	#define FileUser_PLC_ES    "PLC_K1500_100_V42_ES.*"
	#define FileUser_PLC_CX    "PLC_K1500_100_V42_CX.*"
	#define FileUser_PLC_01    "PLC_K1500_100_V42_01.*"
	#define FileUser_PLC_LH    "PLC_K1500_100_V42_LH.*"
	#define FileUser_PLC_NX    "PLC_K1500_100_V42_NX.*"
	#define FileUser_PLC_QL    "PLC_K1500_100_V42_QL.*"
	#define FileUser_PLC_MX    "PLC_K1500_100_V42_MX.*"
	#define FileUser_PLC_FC    "PLC_K1500_100_V42_FC.*"
	#define FileUser_PLC_NW    "PLC_K1500_100_V42_NW.*"
	#define FileUser_PLC_SR    "PLC_K1500_100_V42_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1500_100_V42.zip"
	#define FileFTP_MS        "MS698_K1500_100_V42.zip"
	#define FileFTP_OS        "OS698_K1500_100_V42.zip"
	#define FileFTP_Meter     "Meter698_K1500_100_V42.zip"
	#define FileFTP_Terminal  "Terminal698_K1500_100_V42.zip"
	#define FileFTP_Menu      "Menu698_K1500_100_V42.zip"
	#define FileFTP_Font      "Font_K1500_100_V42.zip"
	#define FileFTP_MODULE    "Module698_K1500_100_V42.zip"
	#define FileFTP_PLC_50    "PLC_K1500_100_V42_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_100_V42_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_100_V42_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_100_V42_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_100_V42_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_100_V42_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_100_V42_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_100_V42_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_100_V42_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_100_V42_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_100_V42_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_100_V42_SR.zip"
#endif
#if MeterSpec==2//电能表规格//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1500_200_V42.*"
	#define FileUser_MS        "MS698_K1500_200_V42.*"
	#define FileUser_OS        "OS698_K1500_200_V42.*"
	#define FileUser_Meter     "Meter698_K1500_200_V42.*"
	#define FileUser_Terminal  "Terminal698_K1500_200_V42.*"
	#define FileUser_Menu      "Menu698_K1500_200_V42.*"
	#define FileUser_Font      "Font_K1500_200_V42.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1500_200_V42.*"
	#define FileUser_PLC_50    "PLC_K1500_200_V42_50.*"
	#define FileUser_PLC_TC    "PLC_K1500_200_V42_TC.*"
	#define FileUser_PLC_ES    "PLC_K1500_200_V42_ES.*"
	#define FileUser_PLC_CX    "PLC_K1500_200_V42_CX.*"
	#define FileUser_PLC_01    "PLC_K1500_200_V42_01.*"
	#define FileUser_PLC_LH    "PLC_K1500_200_V42_LH.*"
	#define FileUser_PLC_NX    "PLC_K1500_200_V42_NX.*"
	#define FileUser_PLC_QL    "PLC_K1500_200_V42_QL.*"
	#define FileUser_PLC_MX    "PLC_K1500_200_V42_MX.*"
	#define FileUser_PLC_FC    "PLC_K1500_200_V42_FC.*"
	#define FileUser_PLC_NW    "PLC_K1500_200_V42_NW.*"
	#define FileUser_PLC_SR    "PLC_K1500_200_V42_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1500_200_V42.zip"
	#define FileFTP_MS        "MS698_K1500_200_V42.zip"
	#define FileFTP_OS        "OS698_K1500_200_V42.zip"
	#define FileFTP_Meter     "Meter698_K1500_200_V42.zip"
	#define FileFTP_Terminal  "Terminal698_K1500_200_V42.zip"
	#define FileFTP_Menu      "Menu698_K1500_200_V42.zip"
	#define FileFTP_Font      "Font_K1500_200_V42.zip"
	#define FileFTP_MODULE    "Module698_K1500_200_V42.zip"
	#define FileFTP_PLC_50    "PLC_K1500_200_V42_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_200_V42_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_200_V42_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_200_V42_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_200_V42_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_200_V42_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_200_V42_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_200_V42_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_200_V42_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_200_V42_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_200_V42_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_200_V42_SR.zip"
#endif


#endif//#if(HVER==0x420)//硬件版本号4.20
...
#define FileUserDIR          "/K1500"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K1500_000_V50.zip"
	#define FileUser_MS        "MS698N_K1500_000_V50.zip"
	#define FileUser_OS        "OS698N_K1500_000_V50.zip"
	#define FileUser_Meter     "Meter698N_K1500_000_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K1500_000_V50.zip"
	#define FileUser_Menu      "Menu698N_K1500_000_V50.zip"
	#define FileUser_Font      "FontN_K1500_000_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K1500_000_V50.zip"
	#define FileUser_PLC_50    "PLC_K1500_000_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K1500_000_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K1500_000_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K1500_000_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K1500_000_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K1500_000_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K1500_000_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K1500_000_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K1500_000_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K1500_000_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K1500_000_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K1500_000_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K1500_000_V50.zip"
	#define FileFTP_MS        "MS698N_K1500_000_V50.zip"
	#define FileFTP_OS        "OS698N_K1500_000_V50.zip"
	#define FileFTP_Meter     "Meter698N_K1500_000_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K1500_000_V50.zip"
	#define FileFTP_Menu      "Menu698N_K1500_000_V50.zip"
	#define FileFTP_Font      "FontN_K1500_000_V50.zip"
	#define FileFTP_MODULE    "Module698N_K1500_000_V50.zip"
	#define FileFTP_PLC_50    "PLC_K1500_000_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_000_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_000_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_000_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_000_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_000_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_000_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_000_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_000_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_000_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_000_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_000_V50_SR.zip"
#endif



#if MeterSpec==19//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K1500_1900_V50.zip"
	#define FileUser_MS        "MS698N_K1500_1900_V50.zip"
	#define FileUser_OS        "OS698N_K1500_1900_V50.zip"
	#define FileUser_Meter     "Meter698N_K1500_1900_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K1500_1900_V50.zip"
	#define FileUser_Menu      "Menu698N_K1500_1900_V50.zip"
	#define FileUser_Font      "FontN_K1500_1900_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K1500_1900_V50.zip"
	#define FileUser_PLC_50    "PLC_K1500_1900_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K1500_1900_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K1500_1900_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K1500_1900_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K1500_1900_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K1500_1900_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K1500_1900_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K1500_1900_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K1500_1900_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K1500_1900_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K1500_1900_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K1500_1900_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K1500_1900_V50.zip"
	#define FileFTP_MS        "MS698N_K1500_1900_V50.zip"
	#define FileFTP_OS        "OS698N_K1500_1900_V50.zip"
	#define FileFTP_Meter     "Meter698N_K1500_1900_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K1500_1900_V50.zip"
	#define FileFTP_Menu      "Menu698N_K1500_1900_V50.zip"
	#define FileFTP_Font      "FontN_K1500_1900_V50.zip"
	#define FileFTP_MODULE    "Module698N_K1500_1900_V50.zip"
	#define FileFTP_PLC_50    "PLC_K1500_1900_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1500_1900_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1500_1900_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1500_1900_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1500_1900_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1500_1900_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1500_1900_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1500_1900_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1500_1900_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1500_1900_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1500_1900_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1500_1900_V50_SR.zip"
#endif
#endif
//硬件版本5.00结束----------------------------------------------------------------------------------
