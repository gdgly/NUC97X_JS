...
//0x10300000-0x103BFFFF 768K MS,OS更新时备份(平时为OS永久备份)
//0x103C0000-0x103DFFFF 128K IEEPROM(有DDR2映射)
//0x103E0000-0x103FFFFF 128K MS永久备份
...
#define ADDR_MSEBACK     0x103E0000//128K MS永久备份
#define ADDR_MeterCalibration_IEEPROM_START     ADDR_IEEPROM_START//128K IEEPROM(有DDR2映射);分为二个64k，后64k是前64k的备份
#endif
...
#if ((ADDR_ICERROR_IEEPROM_End-ADDR_NANDFLASH_BLOCK_REPLACE)>0x4000)
...
#ifdef IC_NUC9xx
#if ((ADDR_ICERROR_IEEPROM_End-ADDR_MeterCalibration_IEEPROM_START)>0x10000)
#error ADDR_IEEPROM Over
#endif
#define  ADDR_BACK_START     (ADDR_MeterCalibration_IEEPROM_START+0x10000)//总64k备份区
#define  ADDR_MeterCalibration_BACK     ADDR_BACK_START//校表参数备份
//4k(1个块长度)
#define  ADDR_Communication_BACK     ADDR_MeterCalibration_BACK+4096//通信参数备份
//4k(1个块长度)


#define  ADDR_BACK_END    (ADDR_Communication_BACK+4096)
#if (ADDR_BACK_END-ADDR_BACK_START)>0x10000
	#error (ADDR_BACK_END-ADDR_BACK_START)>0x10000
#endif
#define ADDR_IEEPROM_End     ADDR_BACK_END
#endif
