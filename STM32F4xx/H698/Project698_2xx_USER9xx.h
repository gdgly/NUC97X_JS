...
#define Terminal_UpDataInit  0//3//6//7//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化,7=参数初始化(档案和nand文件数据转移到新地址)
...
#ifdef IC_STM32F4xx
#define SVER     0x140//软件版本号:V1.0//V1.1//V1.2//V1.3
#define SVDATE   0x200116//0x190717//0x190222//0x181225//0x180704//0x180706//0x180605//0x180604//软件发行日期:年月日
...
#endif
#ifdef IC_NUC9xx
#define SVER     0x100//软件版本号:V1.0//V1.1//V1.2//V1.3
#define SVDATE   0x190520//0x190222//0x181225//0x180704//0x180706//0x180605//0x180604//软件发行日期:年月日
	#ifndef LINUX
...
#define ProduceDate_month       10//4//5//6//生产日期月(hex) 
#define ProduceDate_month_BCD   0x10//0x04//0x05//0x06//生产日期月(BCD) 
...
#define NUM_RMLISTmax  			   64//NUM_RMmax//载波路由主动抄表时用的最大抄表能缓存个数(抄表计数、已抄数据填入等)
...
//#define RMTASKmax 				60//最大任务数(原V1.00配置)
//#define NUMmax_6012_2   	RMTASKmax//最大抄表任务数(原V1.00配置)
//#define NUMmax_6014     	60//最大普通采集方案数(原V1.00配置)
//#define NUMmax_6016     	32//最大事件采集方案数(原V1.00配置)
//#define NUMmax_6018     	32//最大透明方案数(原V1.00配置)
//#define NUMmax_601C     	16//最大上报方案数(此数影响文件管理的最大文件个数)(原V1.00配置)
//#define GPRS_ENET_REPORT  0//GPRS/ENET主动上报:0=上报分开,1=上报合并(原V1.00配置)

#define RMTASKmax 				64//60//最大任务数(当前V1.10配置)
#define NUMmax_6012_2   	RMTASKmax//最大抄表任务数(当前V1.10配置)
#define NUMmax_6014     	64//60//最大普通采集方案数(当前V1.10配置)
#define NUMmax_6016     	64//32//最大事件采集方案数(当前V1.10配置)
#define NUMmax_6018     	64//32//最大透明方案数(当前V1.10配置)
#define NUMmax_601C     	64//16//最大上报方案数(此数影响文件管理的最大文件个数)(当前V1.10配置)
...
#define RM_SECURITY_CompMAC     0//1//0=否,1=是,安全模式抄表时进行MAC校验码比较
...
#define EnMeterAutoReportEvent     0//1//允许电能表主动上报事件:0=不允许,1=允许
...
//用户目录全名
#define FileUserDIR          "/J900"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_J900_000_V4.*"
	#define FileUser_MS        "MS698_J900_000_V4.*"
	#define FileUser_OS        "OS698_J900_000_V4.*"
	#define FileUser_Meter     "Meter698_J900_000_V4.*"
	#define FileUser_Terminal  "Terminal698_J900_000_V4.*"
	#define FileUser_Menu      "Menu698_J900_000_V4.*"
	#define FileUser_Font      "Font_J900_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_J900_000_V4.*"
...
//FTP用文件名
	#define FileFTP_PACK      "PACK698_J900_000_V4.zip"
	#define FileFTP_MS        "MS698_J900_000_V4.zip"
	#define FileFTP_OS        "OS698_J900_000_V4.zip"
	#define FileFTP_Meter     "Meter698_J900_000_V4.zip"
	#define FileFTP_Terminal  "Terminal698_J900_000_V4.zip"
	#define FileFTP_Menu      "Menu698_J900_000_V4.zip"
	#define FileFTP_Font      "Font_J900_000_V4.zip"
	#define FileFTP_MODULE    "Module698_J900_000_V4.zip"
...
#define FileUserDIR          "/J900"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_J900_000_V41.*"
	#define FileUser_MS        "MS698_J900_000_V41.*"
	#define FileUser_OS        "OS698_J900_000_V41.*"
	#define FileUser_Meter     "Meter698_J900_000_V41.*"
	#define FileUser_Terminal  "Terminal698_J900_000_V41.*"
	#define FileUser_Menu      "Menu698_J900_000_V41.*"
	#define FileUser_Font      "Font_J900_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_J900_000_V41.*"
...
//FTP用文件名
	#define FileFTP_PACK      "PACK698_J900_000_V41.zip"
	#define FileFTP_MS        "MS698_J900_000_V41.zip"
	#define FileFTP_OS        "OS698_J900_000_V41.zip"
	#define FileFTP_Meter     "Meter698_J900_000_V41.zip"
	#define FileFTP_Terminal  "Terminal698_J900_000_V41.zip"
	#define FileFTP_Menu      "Menu698_J900_000_V41.zip"
	#define FileFTP_Font      "Font_J900_000_V41.zip"
	#define FileFTP_MODULE    "Module698_J900_000_V41.zip"
