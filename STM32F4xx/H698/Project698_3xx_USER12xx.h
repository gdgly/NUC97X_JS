...
#define SVDATE     0x190702//软件发行日期:年月日
...
#define ALLDATANULLSEL     1//全部数据空时：0=无返回,1=用空数据0
...
#define CompareMeterEventCount     0//1//全事件采集抄表是否比较发生次数:0=不比较(全部抄表数据写入文件),1=比较(只有次数变化的事件写入文件)
...
#define ADC_Vu     0.22//Un时电压ADC输入有效值(ATT7022用)
#define ADC_Vi     0.05//In时电流ADC输入有效值(ATT7022用)
#endif
#if MeterSpec==1
//MeterSpec=1 0.5S 3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
#define MeterClass     0x05//0x02=0.2s级,0x05=0.5s级,0x10=1.0级,0x20=2.0级
...
#define FileUserDIR          "/K1200"
	...
	#define FileUser_PACK      "PACK698_K1200_000_V4.*"
	#define FileUser_MS        "MS698_K1200_000_V4.*"
	#define FileUser_OS        "OS698_K1200_000_V4.*"
	#define FileUser_Meter     "Meter698_K1200_000_V4.*"
	#define FileUser_Terminal  "Terminal698_K1200_000_V4.*"
	#define FileUser_Menu      "Menu698_K1200_000_V4.*"
	#define FileUser_Font      "Font_K1200_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1200_000_V4.*"
	#define FileUser_PLC_50    "PLC_K1200_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1200_000_V4.zip"
	#define FileFTP_MS        "MS698_K1200_000_V4.zip"
	#define FileFTP_OS        "OS698_K1200_000_V4.zip"
	#define FileFTP_Meter     "Meter698_K1200_000_V4.zip"
	#define FileFTP_Terminal  "Terminal698_K1200_000_V4.zip"
	#define FileFTP_Menu      "Menu698_K1200_000_V4.zip"
	#define FileFTP_Font      "Font_K1200_000_V4.zip"
	#define FileFTP_MODULE    "Module698_K1200_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_K1200_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_000_V4_SR.zip"
#endif
...
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1200_000_V41.*"
	#define FileUser_MS        "MS698_K1200_000_V41.*"
	#define FileUser_OS        "OS698_K1200_000_V41.*"
	#define FileUser_Meter     "Meter698_K1200_000_V41.*"
	#define FileUser_Terminal  "Terminal698_K1200_000_V41.*"
	#define FileUser_Menu      "Menu698_K1200_000_V41.*"
	#define FileUser_Font      "Font_K1200_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1200_000_V41.*"
	#define FileUser_PLC_50    "PLC_K1200_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1200_000_V41.zip"
	#define FileFTP_MS        "MS698_K1200_000_V41.zip"
	#define FileFTP_OS        "OS698_K1200_000_V41.zip"
	#define FileFTP_Meter     "Meter698_K1200_000_V41.zip"
	#define FileFTP_Terminal  "Terminal698_K1200_000_V41.zip"
	#define FileFTP_Menu      "Menu698_K1200_000_V41.zip"
	#define FileFTP_Font      "Font_K1200_000_V41.zip"
	#define FileFTP_MODULE    "Module698_K1200_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_K1200_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_000_V41_SR.zip"
#endif
...
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K1200_000_V42.*"
	#define FileUser_MS        "MS698_K1200_000_V42.*"
	#define FileUser_OS        "OS698_K1200_000_V42.*"
	#define FileUser_Meter     "Meter698_K1200_000_V42.*"
	#define FileUser_Terminal  "Terminal698_K1200_000_V42.*"
	#define FileUser_Menu      "Menu698_K1200_000_V42.*"
	#define FileUser_Font      "Font_K1200_000_V42.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K1200_000_V42.*"
	#define FileUser_PLC_50    "PLC_K1200_000_V42_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_000_V42_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_000_V42_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_000_V42_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_000_V42_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_000_V42_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_000_V42_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_000_V42_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_000_V42_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_000_V42_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_000_V42_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_000_V42_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K1200_000_V42.zip"
	#define FileFTP_MS        "MS698_K1200_000_V42.zip"
	#define FileFTP_OS        "OS698_K1200_000_V42.zip"
	#define FileFTP_Meter     "Meter698_K1200_000_V42.zip"
	#define FileFTP_Terminal  "Terminal698_K1200_000_V42.zip"
	#define FileFTP_Menu      "Menu698_K1200_000_V42.zip"
	#define FileFTP_Font      "Font_K1200_000_V42.zip"
	#define FileFTP_MODULE    "Module698_K1200_000_V42.zip"
	#define FileFTP_PLC_50    "PLC_K1200_000_V42_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_000_V42_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_000_V42_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_000_V42_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_000_V42_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_000_V42_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_000_V42_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_000_V42_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_000_V42_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_000_V42_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_000_V42_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_000_V42_SR.zip"
#endif
...
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K1200_000_V50.zip"
	#define FileUser_MS        "MS698N_K1200_000_V50.zip"
	#define FileUser_OS        "OS698N_K1200_000_V50.zip"
	#define FileUser_Meter     "Meter698N_K1200_000_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K1200_000_V50.zip"
	#define FileUser_Menu      "Menu698N_K1200_000_V50.zip"
	#define FileUser_Font      "FontN_K1200_000_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K1200_000_V50.zip"
	#define FileUser_PLC_50    "PLC_K1200_000_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K1200_000_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K1200_000_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K1200_000_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K1200_000_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K1200_000_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K1200_000_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K1200_000_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K1200_000_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K1200_000_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K1200_000_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K1200_000_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K1200_000_V50.zip"
	#define FileFTP_MS        "MS698N_K1200_000_V50.zip"
	#define FileFTP_OS        "OS698N_K1200_000_V50.zip"
	#define FileFTP_Meter     "Meter698N_K1200_000_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K1200_000_V50.zip"
	#define FileFTP_Menu      "Menu698N_K1200_000_V50.zip"
	#define FileFTP_Font      "FontN_K1200_000_V50.zip"
	#define FileFTP_MODULE    "Module698N_K1200_000_V50.zip"
	#define FileFTP_PLC_50    "PLC_K1200_000_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_000_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_000_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_000_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_000_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_000_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_000_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_000_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_000_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_000_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_000_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_000_V50_SR.zip"
#endif

#if MeterSpec==19//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K1200_1900_V50.zip"
	#define FileUser_MS        "MS698N_K1200_1900_V50.zip"
	#define FileUser_OS        "OS698N_K1200_1900_V50.zip"
	#define FileUser_Meter     "Meter698N_K1200_1900_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K1200_1900_V50.zip"
	#define FileUser_Menu      "Menu698N_K1200_1900_V50.zip"
	#define FileUser_Font      "FontN_K1200_1900_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K1200_1900_V50.zip"
	#define FileUser_PLC_50    "PLC_K1200_1900_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K1200_1900_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K1200_1900_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K1200_1900_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K1200_1900_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K1200_1900_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K1200_1900_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K1200_1900_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K1200_1900_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K1200_1900_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K1200_1900_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K1200_1900_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K1200_1900_V50.zip"
	#define FileFTP_MS        "MS698N_K1200_1900_V50.zip"
	#define FileFTP_OS        "OS698N_K1200_1900_V50.zip"
	#define FileFTP_Meter     "Meter698N_K1200_1900_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K1200_1900_V50.zip"
	#define FileFTP_Menu      "Menu698N_K1200_1900_V50.zip"
	#define FileFTP_Font      "FontN_K1200_1900_V50.zip"
	#define FileFTP_MODULE    "Module698N_K1200_1900_V50.zip"
	#define FileFTP_PLC_50    "PLC_K1200_1900_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_1900_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_1900_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_1900_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_1900_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_1900_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_1900_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_1900_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_1900_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_1900_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_1900_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_1900_V50_SR.zip"
#endif
#endif
//硬件版本5.00结束----------------------------------------------------------------------------------
