...
#define Terminal_UpDataInit  0//7//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化,7=参数初始化(档案和nand文件数据转移到新地址)
...
#define EnMainProtocol  0//1//0=否,1=是;软件更新时是否判别主通信协议

#ifdef IC_STM32F4xx
#define SVER     0x140//软件版本号:V1.0//V1.1//V1.2//V1.3
#define SVDATE   0x190218//0x190222//0x181225//0x180704//0x180706//0x180605//0x180604//软件发行日期:年月日
