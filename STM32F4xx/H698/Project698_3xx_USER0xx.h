...
#define Terminal_UpDataInit   3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化,7=参数及数据初始化(档案和nand文件数据转移到新地址)
...
#define SVDATE     0x190424//0x180104//0x160812//软件发行日期:年月日
...
#ifdef IC_NUC9xx
#define SVER    	 0x100//软件版本号:电科院测试为V1.0更新到V1.1
#define SVDATE     0x191204//0x180104//0x160812//软件发行日期:年月日
	#ifndef LINUX
...
#define NAND128kBuff    1//0//定义128k nand写缓冲;0=4k BKPSRAM,1=128k SDRAM
...
#define NUMmax_SWITCHIN     	 2//最大开关量输入路数(门接点)(<=8)
...
#define EnMeterAutoReportEvent     0//允许电能表主动上报事件:0=不允许,1=允许
...
#define FileUserDIR          "/K000"
	...
	#define FileUser_PACK      "PACK698_K000_000_V4.*"
	#define FileUser_MS        "MS698_K000_000_V4.*"
	#define FileUser_OS        "OS698_K000_000_V4.*"
	#define FileUser_Meter     "Meter698_K000_000_V4.*"
	#define FileUser_Terminal  "Terminal698_K000_000_V4.*"
	#define FileUser_Menu      "Menu698_K000_000_V4.*"
	#define FileUser_Font      "Font_K000_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K000_000_V4.*"
	#define FileUser_PLC_50    "PLC_K000_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K000_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K000_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K000_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K000_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K000_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K000_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K000_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K000_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K000_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K000_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K000_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K000_000_V4.zip"
	#define FileFTP_MS        "MS698_K000_000_V4.zip"
	#define FileFTP_OS        "OS698_K000_000_V4.zip"
	#define FileFTP_Meter     "Meter698_K000_000_V4.zip"
	#define FileFTP_Terminal  "Terminal698_K000_000_V4.zip"
	#define FileFTP_Menu      "Menu698_K000_000_V4.zip"
	#define FileFTP_Font      "Font_K000_000_V4.zip"
	#define FileFTP_MODULE    "Module698_K000_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_K000_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K000_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K000_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K000_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K000_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K000_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K000_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K000_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K000_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K000_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K000_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K000_000_V4_SR.zip"
#endif
...
#define FileUserDIR          "/K000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698_K000_000_V41.*"
	#define FileUser_MS        "MS698_K000_000_V41.*"
	#define FileUser_OS        "OS698_K000_000_V41.*"
	#define FileUser_Meter     "Meter698_K000_000_V41.*"
	#define FileUser_Terminal  "Terminal698_K000_000_V41.*"
	#define FileUser_Menu      "Menu698_K000_000_V41.*"
	#define FileUser_Font      "Font_K000_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698_K000_000_V41.*"
	#define FileUser_PLC_50    "PLC_K000_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K000_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K000_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K000_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K000_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K000_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K000_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K000_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K000_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K000_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K000_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K000_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK698_K000_000_V41.zip"
	#define FileFTP_MS        "MS698_K000_000_V41.zip"
	#define FileFTP_OS        "OS698_K000_000_V41.zip"
	#define FileFTP_Meter     "Meter698_K000_000_V41.zip"
	#define FileFTP_Terminal  "Terminal698_K000_000_V41.zip"
	#define FileFTP_Menu      "Menu698_K000_000_V41.zip"
	#define FileFTP_Font      "Font_K000_000_V41.zip"
	#define FileFTP_MODULE    "Module698_K000_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_K000_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K000_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K000_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K000_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K000_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K000_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K000_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K000_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K000_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K000_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K000_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K000_000_V41_SR.zip"
#endif
#endif
//硬件版本结束----------------------------------------------------------------------------------
...
#define FileUserDIR          "/K000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K000_000_V50.zip"
	#define FileUser_MS        "MS698N_K000_000_V50.zip"
	#define FileUser_OS        "OS698N_K000_000_V50.zip"
	#define FileUser_Meter     "Meter698N_K000_000_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K000_000_V50.zip"
	#define FileUser_Menu      "Menu698N_K000_000_V50.zip"
	#define FileUser_Font      "FontN_K000_000_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K000_000_V50.zip"
	#define FileUser_PLC_50    "PLC_K000_000_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K000_000_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K000_000_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K000_000_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K000_000_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K000_000_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K000_000_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K000_000_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K000_000_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K000_000_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K000_000_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K000_000_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K000_000_V50.zip"
	#define FileFTP_MS        "MS698N_K000_000_V50.zip"
	#define FileFTP_OS        "OS698N_K000_000_V50.zip"
	#define FileFTP_Meter     "Meter698N_K000_000_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K000_000_V50.zip"
	#define FileFTP_Menu      "Menu698N_K000_000_V50.zip"
	#define FileFTP_Font      "FontN_K000_000_V50.zip"
	#define FileFTP_MODULE    "Module698N_K000_000_V50.zip"
	#define FileFTP_PLC_50    "PLC_K000_000_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K000_000_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K000_000_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K000_000_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K000_000_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K000_000_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K000_000_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K000_000_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K000_000_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K000_000_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K000_000_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K000_000_V50_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 20000imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K000_100_V50.zip"
	#define FileUser_MS        "MS698N_K000_100_V50.zip"
	#define FileUser_OS        "OS698N_K000_100_V50.zip"
	#define FileUser_Meter     "Meter698N_K000_100_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K000_100_V50.zip"
	#define FileUser_Menu      "Menu698N_K000_100_V50.zip"
	#define FileUser_Font      "FontN_K000_100_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K000_100_V50.zip"
	#define FileUser_PLC_50    "PLC_K000_100_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K000_100_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K000_100_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K000_100_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K000_100_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K000_100_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K000_100_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K000_100_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K000_100_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K000_100_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K000_100_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K000_100_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K000_100_V50.zip"
	#define FileFTP_MS        "MS698N_K000_100_V50.zip"
	#define FileFTP_OS        "OS698N_K000_100_V50.zip"
	#define FileFTP_Meter     "Meter698N_K000_100_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K000_100_V50.zip"
	#define FileFTP_Menu      "Menu698N_K000_100_V50.zip"
	#define FileFTP_Font      "FontN_K000_100_V50.zip"
	#define FileFTP_MODULE    "Module698N_K000_100_V50.zip"
	#define FileFTP_PLC_50    "PLC_K000_100_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K000_100_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K000_100_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K000_100_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K000_100_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K000_100_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K000_100_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K000_100_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K000_100_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K000_100_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K000_100_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K000_100_V50_SR.zip"
#endif


#if MeterSpec==19//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK698N_K000_1900_V50.zip"
	#define FileUser_MS        "MS698N_K000_1900_V50.zip"
	#define FileUser_OS        "OS698N_K000_1900_V50.zip"
	#define FileUser_Meter     "Meter698N_K000_1900_V50.zip"
	#define FileUser_Terminal  "Terminal698N_K000_1900_V50.zip"
	#define FileUser_Menu      "Menu698N_K000_1900_V50.zip"
	#define FileUser_Font      "FontN_K000_1900_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module698N_K000_1900_V50.zip"
	#define FileUser_PLC_50    "PLC_K000_1900_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_K000_1900_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_K000_1900_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_K000_1900_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_K000_1900_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_K000_1900_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_K000_1900_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_K000_1900_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_K000_1900_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_K000_1900_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_K000_1900_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_K000_1900_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACK698N_K000_1900_V50.zip"
	#define FileFTP_MS        "MS698N_K000_1900_V50.zip"
	#define FileFTP_OS        "OS698N_K000_1900_V50.zip"
	#define FileFTP_Meter     "Meter698N_K000_1900_V50.zip"
	#define FileFTP_Terminal  "Terminal698N_K000_1900_V50.zip"
	#define FileFTP_Menu      "Menu698N_K000_1900_V50.zip"
	#define FileFTP_Font      "FontN_K000_1900_V50.zip"
	#define FileFTP_MODULE    "Module698N_K000_1900_V50.zip"
	#define FileFTP_PLC_50    "PLC_K000_1900_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_K000_1900_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K000_1900_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K000_1900_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_K000_1900_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_K000_1900_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K000_1900_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K000_1900_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K000_1900_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K000_1900_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K000_1900_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K000_1900_V50_SR.zip"
#endif
#endif
//硬件版本5.00结束----------------------------------------------------------------------------------
