...
#define MS_UpDataInit     0//3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
#define OS_UpDataInit     0//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
#define Meter_UpDataInit     0//3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
#define Terminal_UpDataInit     0//3//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
...
#define EnUSER     1//0=否,1=是;软件更新时是否判别用户标识
...
#define SVER     0x72//0x71//0x51//0x0052//软件版本号
#define SVDATE     0x190116//0x171023//0x170608//0x170511//0x170119//0x160812//软件发行日期:年月日
...
#define MaxCurveCongeal     (96*30)//(24*10)//最大曲线点数
...
#define DefaultClassNo     0x02//自动搜表默认的用户大类号小类号
...
//用户目录全名
#define FileUserDIR          "/K500"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_K500_000_V4.*"
	#define FileUser_MS        "MS_K500_000_V4.*"
	#define FileUser_OS        "OS_K500_000_V4.*"
	#define FileUser_Meter     "Meter_K500_000_V4.*"
	#define FileUser_Terminal  "Terminal_K500_000_V4.*"
	#define FileUser_Menu      "Menu_K500_000_V4.*"
	#define FileUser_Font      "Font_K500_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K500_000_V4.*"
	#define FileUser_PLC_50    "PLC_K500_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K500_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K500_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K500_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K500_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K500_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K500_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K500_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K500_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K500_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K500_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K500_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K500_000_V4.zip"
	#define FileFTP_MS        "MS_K500_000_V4.zip"
	#define FileFTP_OS        "OS_K500_000_V4.zip"
	#define FileFTP_Meter     "Meter_K500_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_K500_000_V4.zip"
	#define FileFTP_Menu      "Menu_K500_000_V4.zip"
	#define FileFTP_Font      "Font_K500_000_V4.zip"
	#define FileFTP_MODULE    "Module_K500_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_K500_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K500_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K500_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K500_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K500_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K500_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K500_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K500_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K500_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K500_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K500_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K500_000_V4_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=1 0.5S 3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K500_100_V4.*"
	#define FileUser_MS        "MS_K500_100_V4.*"
	#define FileUser_OS        "OS_K500_100_V4.*"
	#define FileUser_Meter     "Meter_K500_100_V4.*"
	#define FileUser_Terminal  "Terminal_K500_100_V4.*"
	#define FileUser_Menu      "Menu_K500_100_V4.*"
	#define FileUser_Font      "Font_K500_100_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K500_100_V4.*"
	#define FileUser_PLC_50    "PLC_K500_100_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K500_100_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K500_100_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K500_100_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K500_100_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K500_100_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K500_100_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K500_100_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K500_100_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K500_100_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K500_100_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K500_100_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K500_100_V4.zip"
	#define FileFTP_MS        "MS_K500_100_V4.zip"
	#define FileFTP_OS        "OS_K500_100_V4.zip"
	#define FileFTP_Meter     "Meter_K500_100_V4.zip"
	#define FileFTP_Terminal  "Terminal_K500_100_V4.zip"
	#define FileFTP_Menu      "Menu_K500_100_V4.zip"
	#define FileFTP_Font      "Font_K500_100_V4.zip"
	#define FileFTP_MODULE    "Module_K500_100_V4.zip"
	#define FileFTP_PLC_50    "PLC_K500_100_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K500_100_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K500_100_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K500_100_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K500_100_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K500_100_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K500_100_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K500_100_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K500_100_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K500_100_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K500_100_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K500_100_V4_SR.zip"
#endif
#if MeterSpec==2//电能表规格//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK_K500_200_V4.*"
	#define FileUser_MS        "MS_K500_200_V4.*"
	#define FileUser_OS        "OS_K500_200_V4.*"
	#define FileUser_Meter     "Meter_K500_200_V4.*"
	#define FileUser_Terminal  "Terminal_K500_200_V4.*"
	#define FileUser_Menu      "Menu_K500_200_V4.*"
	#define FileUser_Font      "Font_K500_200_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K500_200_V4.*"
	#define FileUser_PLC_50    "PLC_K500_200_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K500_200_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K500_200_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K500_200_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K500_200_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K500_200_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K500_200_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K500_200_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K500_200_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K500_200_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K500_200_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K500_200_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K500_200_V4.zip"
	#define FileFTP_MS        "MS_K500_200_V4.zip"
	#define FileFTP_OS        "OS_K500_200_V4.zip"
	#define FileFTP_Meter     "Meter_K500_200_V4.zip"
	#define FileFTP_Terminal  "Terminal_K500_200_V4.zip"
	#define FileFTP_Menu      "Menu_K500_200_V4.zip"
	#define FileFTP_Font      "Font_K500_200_V4.zip"
	#define FileFTP_MODULE    "Module_K500_200_V4.zip"
	#define FileFTP_PLC_50    "PLC_K500_200_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K500_200_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K500_200_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K500_200_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K500_200_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K500_200_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K500_200_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K500_200_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K500_200_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K500_200_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K500_200_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K500_200_V4_SR.zip"
#endif
