...
#define Menu_UpDataInit     3//软件更新仪表初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
...
#define SVDATE     0x180719//0x160812//软件发行日期:年月日
...
#define FileUserDIR          "/J000"
	...
	#define FileUser_PACK      "PACK_J000_000_V4.*"
	#define FileUser_MS        "MS_J000_000_V4.*"
	#define FileUser_OS        "OS_J000_000_V4.*"
	#define FileUser_Meter     "Meter_J000_000_V4.*"
	#define FileUser_Terminal  "Terminal_J000_000_V4.*"
	#define FileUser_Menu      "Menu_J000_000_V4.*"
	#define FileUser_Font      "Font_J000_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J000_000_V4.*"
...
//FTP用文件名
	#define FileFTP_PACK      "PACK_J000_000_V4.zip"
	#define FileFTP_MS        "MS_J000_000_V4.zip"
	#define FileFTP_OS        "OS_J000_000_V4.zip"
	#define FileFTP_Meter     "Meter_J000_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_J000_000_V4.zip"
	#define FileFTP_Menu      "Menu_J000_000_V4.zip"
	#define FileFTP_Font      "Font_J000_000_V4.zip"
	#define FileFTP_MODULE    "Module_J000_000_V4.zip"
