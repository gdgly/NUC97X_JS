...
#define SVDATE     0x150121//软件发行日期:年月日
#define HVER     0x200//硬件版本号:2.00
#define HVDATE     0x130220//硬件发行日期:年月日
...
#define RS485_4PORT     4//RS485_4通信口号(控制模块)
...
//UART4(RS485-4)(控制模块)
#define LEN_UART4IntRx     64//UART4中断接收缓冲长度
#define LEN_UART4Ctrl     200//UART4控制数据长度
#define LEN_UART4Rx     64//UART4接收缓冲长度
#define LEN_UART4Tx     512//UART4发送缓冲长度
...
#define MaxMeterCurveCongeal     (96*6)//最大曲线点数,60的整数倍(搜索时跳越用)
...
//MeterSpec=4 0.5S 3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
...
#define RMM_EndHM     0x2350//结束抄表时分
...
#define RMM_RS485_IntegralCongeal     0//RS485通道抄表,抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
#define RMM_Carrier_IntegralCongeal     0//载波通道抄表,抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
...
#define WaitHeartberatACKMaxTimer     60//心跳发出等待主站确认最大定时秒
...
#define SoftBug1     0//0=正常功能,1==376主站测试软件BUG.小时冻结密度
...
#define AFN0CF41F42F43F44     1//当日电能量AFN0CF41F42F43F44计算;0=示值实时计算,1=当前示值-当日0点冻结
#define AFN0CF45F46F47F48     1//当月电能量AFN0CF45F46F47F48计算;0=示值实时计算,1=当前示值-当月0点冻结
...
#define IC_IS61LV25616     1//0=没,1=有
...
#if(HVER==0x210)//硬件版本号2.10(送电科院测GPRS时区别以前版本的虚拟)
#define CPUCLK     96//CPU时钟cclk:12,24,48,96(MHz)
#define LCDPixels     3//点阵LCD像素 3=160160,2=320240,1=19264,0=SEGMODE
#define IC_LPC177x8x     1//0=没,1=有
#define IC_LPC176x     0//0=没,1=有
