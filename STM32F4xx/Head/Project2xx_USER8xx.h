...
#define SVDATE     0x190125//0x170726//0x160812//软件发行日期:年月日
#ifdef IC_STM32F4xx
//#define HVER     0x400//STM32F4xx硬件版本号:4.00;nandbusbit=16
...
//#define HVDATE   0x181009//NUC972硬件发行日期:年月日
#endif
...
#define MulRealRead     0//1//多帧下发实时抄读或数据转发:0=每帧抄读响应,1=放弃前面帧只抄读最后帧不检查最后帧可能是心跳等的确认帧
...
//用户目录全名
#define FileUserDIR          "/J800"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J800_000_V4.*"
	#define FileUser_MS        "MS_J800_000_V4.*"
	#define FileUser_OS        "OS_J800_000_V4.*"
	#define FileUser_Meter     "Meter_J800_000_V4.*"
	#define FileUser_Terminal  "Terminal_J800_000_V4.*"
	#define FileUser_Menu      "Menu_J800_000_V4.*"
	#define FileUser_Font      "Font_J800_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J800_000_V4.*"
	#define FileUser_PLC_50    "PLC_J800_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_J800_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_J800_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_J800_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_J800_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_J800_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_J800_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_J800_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_J800_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_J800_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_J800_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_J800_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J800_000_V4.zip"
	#define FileFTP_MS        "MS_J800_000_V4.zip"
	#define FileFTP_OS        "OS_J800_000_V4.zip"
	#define FileFTP_Meter     "Meter_J800_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_J800_000_V4.zip"
	#define FileFTP_Menu      "Menu_J800_000_V4.zip"
	#define FileFTP_Font      "Font_J800_000_V4.zip"
	#define FileFTP_MODULE    "Module_J800_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_J800_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_J800_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J800_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J800_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_J800_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_J800_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J800_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J800_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J800_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J800_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J800_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J800_000_V4_SR.zip"
#endif
#endif
//硬件版本结束----------------------------------------------------------------------------------
...
#define FileUserDIR          "/J800"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J800_000_V41.*"
	#define FileUser_MS        "MS_J800_000_V41.*"
	#define FileUser_OS        "OS_J800_000_V41.*"
	#define FileUser_Meter     "Meter_J800_000_V41.*"
	#define FileUser_Terminal  "Terminal_J800_000_V41.*"
	#define FileUser_Menu      "Menu_J800_000_V41.*"
	#define FileUser_Font      "Font_J800_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J800_000_V41.*"
	#define FileUser_PLC_50    "PLC_J800_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_J800_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_J800_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_J800_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_J800_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_J800_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_J800_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_J800_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_J800_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_J800_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_J800_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_J800_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J800_000_V41.zip"
	#define FileFTP_MS        "MS_J800_000_V41.zip"
	#define FileFTP_OS        "OS_J800_000_V41.zip"
	#define FileFTP_Meter     "Meter_J800_000_V41.zip"
	#define FileFTP_Terminal  "Terminal_J800_000_V41.zip"
	#define FileFTP_Menu      "Menu_J800_000_V41.zip"
	#define FileFTP_Font      "Font_J800_000_V41.zip"
	#define FileFTP_MODULE    "Module_J800_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_J800_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_J800_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J800_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J800_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_J800_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_J800_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J800_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J800_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J800_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J800_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J800_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J800_000_V41_SR.zip"
#endif
#endif
//硬件版本结束----------------------------------------------------------------------------------
