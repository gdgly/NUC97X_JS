...
#ifndef AFN0DMaxPn_Project2xx_H
#define AFN0DMaxPn_Project2xx_H
...
#define AFN0DF27MaxPn     MaxRS485Pn//测量点日电压统计数据
	#if (USER/100)==11//吉林
#define AFN0DF27MaxPn_ReadMeter    MaxRS485AddCarrierPn//测量点日电压统计数据
	#endif
...
#define AFN0DF400MaxPn     MaxRS485AddCarrierPn//测量点固定时间点单相电压
#define AFN0DF401MaxPn     MaxRS485AddCarrierPn//测量点固定时间点三相电压、电流
#define AFN0DF402MaxPn     MaxRS485AddCarrierPn//测量点固定时间点A相、零相电流
	#endif
	#if CurveRMTask==1//4点电能、电压、电流曲线抄读任务;0=没有,1=有（20180709mxm）
#define AFN0DF249MaxPn     MaxRS485AddCarrierPn//测量点固定时间点单相电压
#define AFN0DF250MaxPn     MaxRS485AddCarrierPn//测量点固定时间点单相电压
#define AFN0DF251MaxPn     MaxRS485AddCarrierPn//测量点固定时间点三相电压、电流
#define AFN0DF252MaxPn     MaxRS485AddCarrierPn//测量点固定时间点A相、零相电流
	#endif
	
	#if ((USER/100)==12)//用户标识：四川	 扩展日冻结电表采集时间信息
#define AFN0DF245MaxPn     MaxRS485AddCarrierPn//日冻结电表采集时间信息
	#endif
...
#define AFN0DF35MaxPn     MaxRS485Pn//测量点月电压统计数据
	#if (USER/100)==11//吉林
#define AFN0DF35MaxPn_ReadMeter    MaxRS485AddCarrierPn//测量点月电压统计数据
	#endif
...
#define AFN0DF201MaxPn     0//MaxRS485AddCarrierPn//测量点第1时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF202MaxPn     0//MaxRS485AddCarrierPn//测量点第2时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF203MaxPn     0//MaxRS485AddCarrierPn//测量点第3时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF204MaxPn     0//MaxRS485AddCarrierPn//测量点第4时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF205MaxPn     0//MaxRS485AddCarrierPn//测量点第5时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF206MaxPn     0//MaxRS485AddCarrierPn//测量点第6时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF207MaxPn     0//MaxRS485AddCarrierPn//测量点第7时区冻结正向有功电能示值（总、费率1～M）
#define AFN0DF208MaxPn     0//MaxRS485AddCarrierPn//测量点第8时区冻结正向有功电能示值（总、费率1～M）
...
#define AFN0DF219MaxPn     MaxKeyUser//自扩展:集中抄表重点户曲线Pn列表
