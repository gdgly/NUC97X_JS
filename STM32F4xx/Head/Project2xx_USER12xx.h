...
#define EnProject     1//1//0=否,1=是;软件更新时是否判别项目类型
#define EnHV     1//1//0=否,1=是;软件更新时是否判别硬件版本
#define EnUSER     0//1//0=否,1=是;软件更新时是否判别用户标识
#define EnSV     0//0=否,1=是;软件更新时是否判别软件版本号,当允许时只有>=当前版本号才有效
#define EnMeter     0//1//0=否,1=是;I1电能表软件更新时是否判别电表常数接线方式等电表规格
#define EnMainProtocol     1//0=否,1=是;软件更新时是否判别主通信协议

#define SVER     0x100//软件版本号:1.00
#define SVDATE     0x190426//软件发行日期:年月日
...
#define RMM_EndHM     0x2355//结束抄表时分
...
#define RMM_RS485_DateCongeal     1//0//RS485通道抄表抄日冻结;0=否,1=是
...
#define RMM_RS485_Congeal     1//0//RS485通道抄表补抄上2-3日冻结;0=否,1=是
#define RMM_Carrier_Congeal     1//载波通道抄表补抄上2-3日冻结;0=否,1=是
#define RMM_RS485_AddMonth     0//RS485通道抄表补抄上2月冻结;0=否,1=是
#define RMM_Carrier_AddMonth     0//1//载波通道抄表补抄上2月冻结;0=否,1=是
...
#define MaxCarrierUser     1000//最大载波抄表数(4的整数倍)
...
#define MaxControlRound     0//最大控制轮次
...
//FTP用文件名
	...
	#define FileUser_PLC_50    "PLC_K1200_100_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_100_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_100_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_100_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_100_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_100_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_100_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_100_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_100_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_100_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_100_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_100_V4_SR.*"
//FTP用文件名
	...
	#define FileFTP_PLC_50    "PLC_K1200_100_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_100_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_100_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_100_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_100_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_100_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_100_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_100_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_100_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_100_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_100_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_100_V4_SR.zip"
#endif
	...
	#define FileUser_PLC_50    "PLC_K1200_200_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_200_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_200_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_200_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_200_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_200_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_200_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_200_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_200_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_200_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_200_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_200_V4_SR.*"
//FTP用文件名
	...
	#define FileFTP_PLC_50    "PLC_K1200_200_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_200_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_200_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_200_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_200_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_200_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_200_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_200_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_200_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_200_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_200_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_200_V4_SR.zip"
#endif
	...
	#define FileUser_PLC_50    "PLC_K1200_400_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K1200_400_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K1200_400_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K1200_400_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K1200_400_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K1200_400_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K1200_400_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K1200_400_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K1200_400_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K1200_400_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K1200_400_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K1200_400_V4_SR.*"
//FTP用文件名
	...
	#define FileFTP_PLC_50    "PLC_K1200_400_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K1200_400_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K1200_400_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K1200_400_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K1200_400_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K1200_400_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K1200_400_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K1200_400_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K1200_400_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K1200_400_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K1200_400_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K1200_400_V4_SR.zip"
#endif
#endif
...
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J000_000_V41.*"
	#define FileUser_MS        "MS_J000_000_V41.*"
	#define FileUser_OS        "OS_J000_000_V41.*"
	#define FileUser_Meter     "Meter_J000_000_V41.*"
	#define FileUser_Terminal  "Terminal_J000_000_V41.*"
	#define FileUser_Menu      "Menu_J000_000_V41.*"
	#define FileUser_Font      "Font_J000_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J000_000_V41.*"
...
//FTP用文件名
	#define FileFTP_PACK      "PACK_J000_000_V41.zip"
	#define FileFTP_MS        "MS_J000_000_V41.zip"
	#define FileFTP_OS        "OS_J000_000_V41.zip"
	#define FileFTP_Meter     "Meter_J000_000_V41.zip"
	#define FileFTP_Terminal  "Terminal_J000_000_V41.zip"
	#define FileFTP_Menu      "Menu_J000_000_V41.zip"
	#define FileFTP_Font      "Font_J000_000_V41.zip"
	#define FileFTP_MODULE    "Module_J000_000_V41.zip"
