...
#define SVER     0x100//软件版本号
#define SVDATE     0x181130//软件发行日期:年月日
...
#define LEN_UART2FnDataBuff     512//256//UART2抄表Fn数据缓冲长度
//UART3(RS485-2)
...
#define LEN_UART3FnDataBuff     512//256//UART3抄表Fn数据缓冲长度
//UART4(RS485-4)(载波)
...
#define LEN_UART4FnDataBuff     0//256//UART4抄表Fn数据缓冲长度
//UART5(RS485-3)(WI-FI)
...
#define MaxMeterCurveCongeal     (96*6)//0//最大曲线点数,60的整数倍(搜索时跳越用)
...
#define RMM_Carrier_IntegralCongeal     2//载波通道抄表抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
...
#define MaxKeyUser     MaxRS485User//最大集中抄表重点用户数
...
#define MaxCurveCongeal_Ext     0//最大线电压曲线点数（上海扩展）
#define MaxERC     68//最大事件ERC号
...
#define WaitHostACKMinTimer     30//5//主动上报等待主站确认最小定时秒
#define WaitHostACKMaxTimer     60//120//60//主动上报等待主站确认最大定时秒
...
//用户目录全名
#define FileUserDIR          "/K800"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_000_V4.*"
	#define FileUser_MS        "MS_K800_000_V4.*"
	#define FileUser_OS        "OS_K800_000_V4.*"
	#define FileUser_Meter     "Meter_K800_000_V4.*"
	#define FileUser_Terminal  "Terminal_K800_000_V4.*"
	#define FileUser_Menu      "Menu_K800_000_V4.*"
	#define FileUser_Font      "Font_K800_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_000_V4.*"
	#define FileUser_PLC_50    "PLC_K800_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K800_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K800_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K800_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_000_V4.zip"
	#define FileFTP_MS        "MS_K800_000_V4.zip"
	#define FileFTP_OS        "OS_K800_000_V4.zip"
	#define FileFTP_Meter     "Meter_K800_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_K800_000_V4.zip"
	#define FileFTP_Menu      "Menu_K800_000_V4.zip"
	#define FileFTP_Font      "Font_K800_000_V4.zip"
	#define FileFTP_MODULE    "Module_K800_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_K800_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_000_V4_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=1 0.5S 3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_100_V4.*"
	#define FileUser_MS        "MS_K800_100_V4.*"
	#define FileUser_OS        "OS_K800_100_V4.*"
	#define FileUser_Meter     "Meter_K800_100_V4.*"
	#define FileUser_Terminal  "Terminal_K800_100_V4.*"
	#define FileUser_Menu      "Menu_K800_100_V4.*"
	#define FileUser_Font      "Font_K800_100_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_100_V4.*"
	#define FileUser_PLC_50    "PLC_K800_100_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K800_100_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_100_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_100_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K800_100_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K800_100_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_100_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_100_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_100_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_100_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_100_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_100_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_100_V4.zip"
	#define FileFTP_MS        "MS_K800_100_V4.zip"
	#define FileFTP_OS        "OS_K800_100_V4.zip"
	#define FileFTP_Meter     "Meter_K800_100_V4.zip"
	#define FileFTP_Terminal  "Terminal_K800_100_V4.zip"
	#define FileFTP_Menu      "Menu_K800_100_V4.zip"
	#define FileFTP_Font      "Font_K800_100_V4.zip"
	#define FileFTP_MODULE    "Module_K800_100_V4.zip"
	#define FileFTP_PLC_50    "PLC_K800_100_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_100_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_100_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_100_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_100_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_100_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_100_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_100_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_100_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_100_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_100_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_100_V4_SR.zip"
#endif
#if MeterSpec==2//电能表规格//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_200_V4.*"
	#define FileUser_MS        "MS_K800_200_V4.*"
	#define FileUser_OS        "OS_K800_200_V4.*"
	#define FileUser_Meter     "Meter_K800_200_V4.*"
	#define FileUser_Terminal  "Terminal_K800_200_V4.*"
	#define FileUser_Menu      "Menu_K800_200_V4.*"
	#define FileUser_Font      "Font_K800_200_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_200_V4.*"
	#define FileUser_PLC_50    "PLC_K800_200_V4_50.*"
	#define FileUser_PLC_TC    "PLC_K800_200_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_200_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_200_V4_CX.*"
	#define FileUser_PLC_01    "PLC_K800_200_V4_01.*"
	#define FileUser_PLC_LH    "PLC_K800_200_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_200_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_200_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_200_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_200_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_200_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_200_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_200_V4.zip"
	#define FileFTP_MS        "MS_K800_200_V4.zip"
	#define FileFTP_OS        "OS_K800_200_V4.zip"
	#define FileFTP_Meter     "Meter_K800_200_V4.zip"
	#define FileFTP_Terminal  "Terminal_K800_200_V4.zip"
	#define FileFTP_Menu      "Menu_K800_200_V4.zip"
	#define FileFTP_Font      "Font_K800_200_V4.zip"
	#define FileFTP_MODULE    "Module_K800_200_V4.zip"
	#define FileFTP_PLC_50    "PLC_K800_200_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_200_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_200_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_200_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_200_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_200_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_200_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_200_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_200_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_200_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_200_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_200_V4_SR.zip"
#endif
#endif
//硬件版本结束----------------------------------------------------------------------------------
...
#define FileUserDIR          "/K800"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_000_V41.*"
	#define FileUser_MS        "MS_K800_000_V41.*"
	#define FileUser_OS        "OS_K800_000_V41.*"
	#define FileUser_Meter     "Meter_K800_000_V41.*"
	#define FileUser_Terminal  "Terminal_K800_000_V41.*"
	#define FileUser_Menu      "Menu_K800_000_V41.*"
	#define FileUser_Font      "Font_K800_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_000_V41.*"
	#define FileUser_PLC_50    "PLC_K800_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K800_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K800_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K800_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_000_V41.zip"
	#define FileFTP_MS        "MS_K800_000_V41.zip"
	#define FileFTP_OS        "OS_K800_000_V41.zip"
	#define FileFTP_Meter     "Meter_K800_000_V41.zip"
	#define FileFTP_Terminal  "Terminal_K800_000_V41.zip"
	#define FileFTP_Menu      "Menu_K800_000_V41.zip"
	#define FileFTP_Font      "Font_K800_000_V41.zip"
	#define FileFTP_MODULE    "Module_K800_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_K800_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_000_V41_SR.zip"
#endif
#if MeterSpec==1//电能表规格//MeterSpec=1 0.5S 3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_100_V41.*"
	#define FileUser_MS        "MS_K800_100_V41.*"
	#define FileUser_OS        "OS_K800_100_V41.*"
	#define FileUser_Meter     "Meter_K800_100_V41.*"
	#define FileUser_Terminal  "Terminal_K800_100_V41.*"
	#define FileUser_Menu      "Menu_K800_100_V41.*"
	#define FileUser_Font      "Font_K800_100_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_100_V41.*"
	#define FileUser_PLC_50    "PLC_K800_100_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K800_100_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_100_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_100_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K800_100_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K800_100_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_100_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_100_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_100_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_100_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_100_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_100_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_100_V41.zip"
	#define FileFTP_MS        "MS_K800_100_V41.zip"
	#define FileFTP_OS        "OS_K800_100_V41.zip"
	#define FileFTP_Meter     "Meter_K800_100_V41.zip"
	#define FileFTP_Terminal  "Terminal_K800_100_V41.zip"
	#define FileFTP_Menu      "Menu_K800_100_V41.zip"
	#define FileFTP_Font      "Font_K800_100_V41.zip"
	#define FileFTP_MODULE    "Module_K800_100_V41.zip"
	#define FileFTP_PLC_50    "PLC_K800_100_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_100_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_100_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_100_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_100_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_100_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_100_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_100_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_100_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_100_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_100_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_100_V41_SR.zip"
#endif
#if MeterSpec==2//电能表规格//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK_K800_200_V41.*"
	#define FileUser_MS        "MS_K800_200_V41.*"
	#define FileUser_OS        "OS_K800_200_V41.*"
	#define FileUser_Meter     "Meter_K800_200_V41.*"
	#define FileUser_Terminal  "Terminal_K800_200_V41.*"
	#define FileUser_Menu      "Menu_K800_200_V41.*"
	#define FileUser_Font      "Font_K800_200_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K800_200_V41.*"
	#define FileUser_PLC_50    "PLC_K800_200_V41_50.*"
	#define FileUser_PLC_TC    "PLC_K800_200_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_K800_200_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_K800_200_V41_CX.*"
	#define FileUser_PLC_01    "PLC_K800_200_V41_01.*"
	#define FileUser_PLC_LH    "PLC_K800_200_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_K800_200_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_K800_200_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_K800_200_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_K800_200_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_K800_200_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_K800_200_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_K800_200_V41.zip"
	#define FileFTP_MS        "MS_K800_200_V41.zip"
	#define FileFTP_OS        "OS_K800_200_V41.zip"
	#define FileFTP_Meter     "Meter_K800_200_V41.zip"
	#define FileFTP_Terminal  "Terminal_K800_200_V41.zip"
	#define FileFTP_Menu      "Menu_K800_200_V41.zip"
	#define FileFTP_Font      "Font_K800_200_V41.zip"
	#define FileFTP_MODULE    "Module_K800_200_V41.zip"
	#define FileFTP_PLC_50    "PLC_K800_200_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_K800_200_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_K800_200_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_K800_200_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_K800_200_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_K800_200_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_K800_200_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_K800_200_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_K800_200_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_K800_200_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_K800_200_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_K800_200_V41_SR.zip"
#endif
#endif
//硬件版本结束----------------------------------------------------------------------------------
