...
//版本-------------------------------------------------------------------------------------
#define I0_UpDataInit     3//3//I0软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4=参数(除与系统主站通信有关的)及全体数据区初始化,5=参数及全体数据区初始化(即恢复至出厂配置)后硬件复位,6=仅部份参数初始化
#define I1_UpDataInit     3//I1软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4=参数(除与系统主站通信有关的)及全体数据区初始化,5=参数及全体数据区初始化(即恢复至出厂配置)后硬件复位,6=仅部份参数初始化
#define I2_UpDataInit     3//I2软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4=参数(除与系统主站通信有关的)及全体数据区初始化,5=参数及全体数据区初始化(即恢复至出厂配置)后硬件复位,6=仅部份参数初始化
...
#define SVDATE     0x151020//软件发行日期:年月日
...
#define RMM_RS485_AddMonth     1//RS485通道抄表补抄上2月冻结;0=否,1=是
#define RMM_Carrier_AddMonth     1//载波通道抄表补抄上2月冻结;0=否,1=是
...
#define MaxCarrierUser     1500//最大载波抄表数(4的整数倍)
...
#define MaxDateCongeal     62//最大日冻结数
...
#define SMSEQ2Byte     0//0=没,1=有;短信传输通道的数据单元中2字节短信传输接口(标准376.1中有)
...
//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_000_V2_I0.bin"
			#define USBFileName_I1    "J700_000_V2_I1.bin"
			#define USBFileName_I2    "J700_000_V2_I2.bin"
			#define USBFileName_E1    "J700_000_V2_E1.bin"
			#define USBFileName_E2    "J700_000_V2_E2.bin"
			#define USBFileName_E3    "J700_000_V2_E3.bin"
			#define USBFileName_E4_50 "J700_000_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_000_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_000_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_000_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_000_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_000_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_000_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_000_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_000_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_000_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_000_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_000_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_000_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_000_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_000_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_000_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_000_V2_E5_01.bin"
			#endif
			#if MeterSpec==1//电能表规格
//MeterSpec=1 0.5S 3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_100_V2_I0.bin"
			#define USBFileName_I1    "J700_100_V2_I1.bin"
			#define USBFileName_I2    "J700_100_V2_I2.bin"
			#define USBFileName_E1    "J700_100_V2_E1.bin"
			#define USBFileName_E2    "J700_100_V2_E2.bin"
			#define USBFileName_E3    "J700_100_V2_E3.bin"
			#define USBFileName_E4_50 "J700_100_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_100_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_100_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_100_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_100_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_100_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_100_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_100_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_100_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_100_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_100_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_100_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_100_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_100_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_100_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_100_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_100_V2_E5_01.bin"
			#endif
			#if MeterSpec==2//电能表规格
//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_200_V2_I0.bin"
			#define USBFileName_I1    "J700_200_V2_I1.bin"
			#define USBFileName_I2    "J700_200_V2_I2.bin"
			#define USBFileName_E1    "J700_200_V2_E1.bin"
			#define USBFileName_E2    "J700_200_V2_E2.bin"
			#define USBFileName_E3    "J700_200_V2_E3.bin"
			#define USBFileName_E4_50 "J700_200_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_200_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_200_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_200_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_200_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_200_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_200_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_200_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_200_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_200_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_200_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_200_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_200_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_200_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_200_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_200_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_200_V2_E5_01.bin"
			#endif
			#if MeterSpec==3//电能表规格
//MeterSpec=3 1.0  3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_300_V2_I0.bin"
			#define USBFileName_I1    "J700_300_V2_I1.bin"
			#define USBFileName_I2    "J700_300_V2_I2.bin"
			#define USBFileName_E1    "J700_300_V2_E1.bin"
			#define USBFileName_E2    "J700_300_V2_E2.bin"
			#define USBFileName_E3    "J700_300_V2_E3.bin"
			#define USBFileName_E4_50 "J700_300_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_300_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_300_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_300_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_300_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_300_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_300_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_300_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_300_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_300_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_300_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_300_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_300_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_300_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_300_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_300_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_300_V2_E5_01.bin"
			#endif
			#if MeterSpec==4//电能表规格
//MeterSpec=4 1.0  3P3W 50Hz 6400imp/kWh 100V 1.5(6)A
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_400_V2_I0.bin"
			#define USBFileName_I1    "J700_400_V2_I1.bin"
			#define USBFileName_I2    "J700_400_V2_I2.bin"
			#define USBFileName_E1    "J700_400_V2_E1.bin"
			#define USBFileName_E2    "J700_400_V2_E2.bin"
			#define USBFileName_E3    "J700_400_V2_E3.bin"
			#define USBFileName_E4_50 "J700_400_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_400_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_400_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_400_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_400_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_400_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_400_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_400_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_400_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_400_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_400_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_400_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_400_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_400_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_400_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_400_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_400_V2_E5_01.bin"
			#endif
			#if MeterSpec==5//电能表规格
//MeterSpec=5 1.0  3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)
			#define USBFileDIR     "/J700"
			#define USBFileName_I0    "J700_500_V2_I0.bin"
			#define USBFileName_I1    "J700_500_V2_I1.bin"
			#define USBFileName_I2    "J700_500_V2_I2.bin"
			#define USBFileName_E1    "J700_500_V2_E1.bin"
			#define USBFileName_E2    "J700_500_V2_E2.bin"
			#define USBFileName_E3    "J700_500_V2_E3.bin"
			#define USBFileName_E4_50 "J700_500_V2_E4_50.bin"
			#define USBFileName_E4_TC "J700_500_V2_E4_TC.bin"
			#define USBFileName_E4_ES "J700_500_V2_E4_ES.bin"
			#define USBFileName_E4_CX "J700_500_V2_E4_CX.bin"
			#define USBFileName_E4_01 "J700_500_V2_E4_01.bin"
			#define USBFileName_E4_LH "J700_500_V2_E4_LH.bin"
			#define USBFileName_E4_NX "J700_500_V2_E4_NX.bin"
			#define USBFileName_E4_QL "J700_500_V2_E4_QL.bin"
			#define USBFileName_E4_MX "J700_500_V2_E4_MX.bin"
			#define USBFileName_E4_FC "J700_500_V2_E4_FC.bin"
			#define USBFileName_E4_NW "J700_500_V2_E4_NW.bin"
			#define USBFileName_E4_SR "J700_500_V2_E4_SR.bin"
			#define USBFileName_E5_50 "J700_500_V2_E5_50.bin"
			#define USBFileName_E5_TC "J700_500_V2_E5_TC.bin"
			#define USBFileName_E5_ES "J700_500_V2_E5_ES.bin"
			#define USBFileName_E5_CX "J700_500_V2_E5_CX.bin"
			#define USBFileName_E5_01 "J700_500_V2_E5_01.bin"
			#endif
