...
//己发行软件版本号1.xx
//软件版本号2.xx为新电能表事件采集方案,与1.xx在ERAM的档案列表结构长度不兼容
#define SVER     0x120//0x110//0x100//软件版本号:1.00
#define SVDATE     0x150122//0x140529//0x140425//软件发行日期:年月日
...
#define RMM_RS485_PassageZero     1//RS485通道抄表过0点;0=不暂停,1=暂停
	#if USERTEST==0//0=正常功能,1=各省级用户电科院送检
...
#define UartMonthTI     0//月冻结的召读时标0=该月未的24时数据,1=该月初1日的0时数据
	#else
#define RMM_StartHM     0x0002//起动抄表时分
...
#define WeekRMTask        1//每周抄表任务;0=没有,1=有(载波修改为当抄表失败时为加快任务退出不抄后续数据项)(替代每日的时任务:三相表用户包括居民用户和工商业用户当前电压、电流、断相累计时间数据的采集)
...
#define MaxCarrierUser     1492//1600//最大载波抄表数(4的整数倍)
...
#define MaxDateCongeal     90//62//31//最大日冻结数
#define MaxRMDateCongeal     6//31//最大抄表日冻结数
...
#define SM_CMGF     1//短信模式:0=PDU模式,1=文本模式
...
#define Uart3761Check0xEE   1//0xEE数据检查:0=不检查;1=检查,若全0xEE返回否认
