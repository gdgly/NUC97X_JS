...
#define SVDATE     0x140102//软件发行日期:年月日
...
#define MaxCarrierUser     1600//1680//最大载波抄表数(4的整数倍)
...
#define SoftBug3     0//抄表上月最大需量0=比较需量产生的月,1=不比较需量产生的月
...
#define ReadF129Above    0//召读1类F129以上数据:0=读原存储数据,1=实时读取后再上传
