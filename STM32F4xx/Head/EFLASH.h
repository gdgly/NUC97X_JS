...
#define LENmax_Download         (1024*1024)//(512*1024)
//1024K MS,OS,Router更新时备份


//掉电时数据保护区--------------------------------------------------------------------------------
#define ADDR_DISK_Start     (ADDR_Download_ENTRY+LENmax_Download)
#define LEN_DISK     (8*128*1024)//掉电时数据保护区长度
//128K 电源掉电时数据保存1
//128K 电源掉电时数据保存2
//128K 电源掉电时数据保存3
//128K 电源掉电时数据保存4
...
#define ADDR_Terminal_EFLASH_Start     (ADDR_Meter_EFLASH_Start+LEN_Meter_EFLASH)
	...
	#define LEN_Terminal_EFLASH     0//限定总长度字节数
		...
		//6M 减去Meter
		//1M 减去LOG
		#define LEN_Terminal_EFLASH_AFN04     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN05     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0E     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0C_HourCongeal     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D_Source     (3*1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D     (72*1024*1024)
		#define LEN_FLASH_FILE                (25*1024*1024)
	#endif
		...
		#define LEN_Terminal_EFLASH_AFN0C_HourCongeal     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D_Source     (3*1024*1024)
	#if (((Project/100)==2)&&((USER/100)==14)&&(HVER<0x500))//福建系	集中器
		#define LEN_Terminal_EFLASH_AFN0D     (90*1024*1024)
	#endif
	#ifndef LEN_Terminal_EFLASH_AFN0D
		#define LEN_Terminal_EFLASH_AFN0D     (190*1024*1024)
	#endif	
	#if (((Project/100)==2)&&((USER/100)==14)&&(HVER<0x500))//福建系	集中器	
		#define LEN_Terminal_EFLASH_AFN54     (7*1024*1024)//ST32F4xx插入在AFN04和AFN05间    //NUC97x插在AFN0D后
		#define LEN_Terminal_EFLASH_AFN56	    (93*1024*1024)//ST32F4xx插入在AFN0D后    //NUC97x插在AFN54后
		#define LEN_FLASH_FILE                (9*1024*1024)	
	#else
		#define LEN_FLASH_FILE                (25*1024*1024)		
	#endif
	#endif
		...
		#define LEN_Terminal_EFLASH_AFN0C_HourCongeal     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D_Source     (3*1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D     (438*1024*1024)
		#define LEN_FLASH_FILE                (25*1024*1024)
	#endif
		...
		#define LEN_Terminal_EFLASH_AFN0C_HourCongeal     (1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D_Source     (3*1024*1024)
		#define LEN_Terminal_EFLASH_AFN0D     (934*1024*1024)
		#define LEN_FLASH_FILE                (25*1024*1024)
	#endif
	#include "EFLASH_Terminal.h"
#endif
