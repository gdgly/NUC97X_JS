...
#define EnHV     0//1//0=否,1=是;软件更新时是否判别硬件版本
...
#if (HVER==0x400)
#define SVER     0x132//软件版本号:    //1.32    尾数为电压规格   1:100   2：220     5:57.7  
#define SVDATE     0x180510//0x180412//0x180117//软件发行日期:年月日
//#define HVER     0x400//硬件版本号:4.00
#define HVDATE     0x160701//硬件发行日期:年月日
#endif

#if (HVER==0x410)
#define SVER     0x102//软件版本号:1.02     尾数为电压规格   1:100   2：220     5:57.7  
#define SVDATE     0x191028//软件发行日期:年月日
//#define HVER     0x410//硬件版本号:4.10
#define HVDATE     0x190501//硬件发行日期:年月日
#endif
#endif

#ifdef IC_NUC9xx
#define SVER     0x100//软件版本号x.xx:尾数为电压规格   1:100   2：220     5:57.7
#define SVDATE   0x190726//软件发行日期:年月日
	#ifndef LINUX
...
#define LEN_UART11Ctrl     256//UART11控制数据长度
#define LEN_UART11Rx     1024//UART11接收缓冲长度
#define LEN_UART11Tx     1024//UART11发送缓冲长度
#define LEN_UART11TxMax     1024//UART11发送缓冲预留的最大长度(注:确保LEN_UART11Tx<=LEN_UART11TxMax)
...
#define MaxMeterCurveCongeal     0//最大曲线点数,60的整数倍(搜索时跳越用)
...
#define MeterIMaxhex     600//最大电流xx.xx(A)
#define MeterIMaxbcd     0x600//最大电流xx.xx(A)
#define MeterPStartupHex     (MeterUBhex*MeterIBhex*0.0005)//(MeterUBhex*MeterIBhex*0.00066)//有功起动功率xxxxx.xxx(Watt)
#define MeterQStartupHex     (MeterUBhex*MeterIBhex*0.0005)//(MeterUBhex*MeterIBhex*0.00066)//无功起动功率xxxxx.xxx(var)
#define ADC_Vu     0.33//Un时电压ADC输入有效值(ATT7022用)
#define ADC_Vi     0.068//In时电流ADC输入有效值(ATT7022用)
#endif
#if MeterSpec==18
...
#define RMM_RS485_IntegralCongeal     2//RS485通道抄表抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
...
#define MaxRS485User     32//最大RS485抄表数(4的整数倍)
#define MaxKeyUser     32//最大集中抄表重点用户数
#define MaxCarrierUser     0//最大载波抄表数(4的整数倍)
...
#define MaxControlRound     2//最大控制轮次
#define MaxTimerTask     64//最大定时任务数
#define MaxTimerTaskDI     8//最大定时任务数据标识个数
#define MaxImpInPort     2//最大脉冲输入端口数(<=8)
#define MaxSwitchInPort     (2+1)//最大开关量输入端口数(<=8,开关量输入端口数+门接点)
...
#define MaxRMDateCongeal     31//最大抄表日冻结数
...
//用户目录全名
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_000_V4.*"
	#define FileUser_MS        "MS_K1200_000_V4.*"
	#define FileUser_OS        "OS_K1200_000_V4.*"
	#define FileUser_Meter     "Meter_K1200_000_V4.*"
	#define FileUser_Terminal  "Terminal_K1200_000_V4.*"
	#define FileUser_Menu      "Menu_K1200_000_V4.*"
	#define FileUser_Font      "Font_K1200_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_000_V4.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_000_V4.zip"
	#define FileFTP_MS        "MS_K1200_000_V4.zip"
	#define FileFTP_OS        "OS_K1200_000_V4.zip"
	#define FileFTP_Meter     "Meter_K1200_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_K1200_000_V4.zip"
	#define FileFTP_Menu      "Menu_K1200_000_V4.zip"
	#define FileFTP_Font      "Font_K1200_000_V4.zip"
	#define FileFTP_MODULE    "Module_K1200_000_V4.zip"

#endif
#if MeterSpec==1//电能表规格//MeterSpec=4 1.0  3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_100_V4.*"
	#define FileUser_MS        "MS_K1200_100_V4.*"
	#define FileUser_OS        "OS_K1200_100_V4.*"
	#define FileUser_Meter     "Meter_K1200_100_V4.*"
	#define FileUser_Terminal  "Terminal_K1200_100_V4.*"
	#define FileUser_Menu      "Menu_K1200_100_V4.*"
	#define FileUser_Font      "Font_K1200_100_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_100_V4.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_100_V4.zip"
	#define FileFTP_MS        "MS_K1200_100_V4.zip"
	#define FileFTP_OS        "OS_K1200_100_V4.zip"
	#define FileFTP_Meter     "Meter_K1200_100_V4.zip"
	#define FileFTP_Terminal  "Terminal_K1200_100_V4.zip"
	#define FileFTP_Menu      "Menu_K1200_100_V4.zip"
	#define FileFTP_Font      "Font_K1200_100_V4.zip"
	#define FileFTP_MODULE    "Module_K1200_100_V4.zip"

#endif
#if MeterSpec==2//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_200_V4.*"
	#define FileUser_MS        "MS_K1200_200_V4.*"
	#define FileUser_OS        "OS_K1200_200_V4.*"
	#define FileUser_Meter     "Meter_K1200_200_V4.*"
	#define FileUser_Terminal  "Terminal_K1200_200_V4.*"
	#define FileUser_Menu      "Menu_K1200_200_V4.*"
	#define FileUser_Font      "Font_K1200_200_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_200_V4.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_200_V4.zip"
	#define FileFTP_MS        "MS_K1200_200_V4.zip"
	#define FileFTP_OS        "OS_K1200_200_V4.zip"
	#define FileFTP_Meter     "Meter_K1200_200_V4.zip"
	#define FileFTP_Terminal  "Terminal_K1200_200_V4.zip"
	#define FileFTP_Menu      "Menu_K1200_200_V4.zip"
	#define FileFTP_Font      "Font_K1200_200_V4.zip"
	#define FileFTP_MODULE    "Module_K1200_200_V4.zip"

#endif


#if MeterSpec==4//电能表规格//MeterSpec=4 1.0  3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_400_V4.*"
	#define FileUser_MS        "MS_K1200_400_V4.*"
	#define FileUser_OS        "OS_K1200_400_V4.*"
	#define FileUser_Meter     "Meter_K1200_400_V4.*"
	#define FileUser_Terminal  "Terminal_K1200_400_V4.*"
	#define FileUser_Menu      "Menu_K1200_400_V4.*"
	#define FileUser_Font      "Font_K1200_400_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_400_V4.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_400_V4.zip"
	#define FileFTP_MS        "MS_K1200_400_V4.zip"
	#define FileFTP_OS        "OS_K1200_400_V4.zip"
	#define FileFTP_Meter     "Meter_K1200_400_V4.zip"
	#define FileFTP_Terminal  "Terminal_K1200_400_V4.zip"
	#define FileFTP_Menu      "Menu_K1200_400_V4.zip"
	#define FileFTP_Font      "Font_K1200_400_V4.zip"
	#define FileFTP_MODULE    "Module_K1200_400_V4.zip"
...
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_000_V41.*"
	#define FileUser_MS        "MS_K1200_000_V41.*"
	#define FileUser_OS        "OS_K1200_000_V41.*"
	#define FileUser_Meter     "Meter_K1200_000_V41.*"
	#define FileUser_Terminal  "Terminal_K1200_000_V41.*"
	#define FileUser_Menu      "Menu_K1200_000_V41.*"
	#define FileUser_Font      "Font_K1200_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_000_V41.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_000_V41.zip"
	#define FileFTP_MS        "MS_K1200_000_V41.zip"
	#define FileFTP_OS        "OS_K1200_000_V41.zip"
	#define FileFTP_Meter     "Meter_K1200_000_V41.zip"
	#define FileFTP_Terminal  "Terminal_K1200_000_V41.zip"
	#define FileFTP_Menu      "Menu_K1200_000_V41.zip"
	#define FileFTP_Font      "Font_K1200_000_V41.zip"
	#define FileFTP_MODULE    "Module_K1200_000_V41.zip"

#endif
#if MeterSpec==1//电能表规格//MeterSpec=4 1.0  3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_100_V41.*"
	#define FileUser_MS        "MS_K1200_100_V41.*"
	#define FileUser_OS        "OS_K1200_100_V41.*"
	#define FileUser_Meter     "Meter_K1200_100_V41.*"
	#define FileUser_Terminal  "Terminal_K1200_100_V41.*"
	#define FileUser_Menu      "Menu_K1200_100_V41.*"
	#define FileUser_Font      "Font_K1200_100_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_100_V41.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_100_V41.zip"
	#define FileFTP_MS        "MS_K1200_100_V41.zip"
	#define FileFTP_OS        "OS_K1200_100_V41.zip"
	#define FileFTP_Meter     "Meter_K1200_100_V41.zip"
	#define FileFTP_Terminal  "Terminal_K1200_100_V41.zip"
	#define FileFTP_Menu      "Menu_K1200_100_V41.zip"
	#define FileFTP_Font      "Font_K1200_100_V41.zip"
	#define FileFTP_MODULE    "Module_K1200_100_V41.zip"

#endif
#if MeterSpec==2//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_200_V41.*"
	#define FileUser_MS        "MS_K1200_200_V41.*"
	#define FileUser_OS        "OS_K1200_200_V41.*"
	#define FileUser_Meter     "Meter_K1200_200_V41.*"
	#define FileUser_Terminal  "Terminal_K1200_200_V41.*"
	#define FileUser_Menu      "Menu_K1200_200_V41.*"
	#define FileUser_Font      "Font_K1200_200_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_200_V41.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_200_V41.zip"
	#define FileFTP_MS        "MS_K1200_200_V41.zip"
	#define FileFTP_OS        "OS_K1200_200_V41.zip"
	#define FileFTP_Meter     "Meter_K1200_200_V41.zip"
	#define FileFTP_Terminal  "Terminal_K1200_200_V41.zip"
	#define FileFTP_Menu      "Menu_K1200_200_V41.zip"
	#define FileFTP_Font      "Font_K1200_200_V41.zip"
	#define FileFTP_MODULE    "Module_K1200_200_V41.zip"

#endif


#if MeterSpec==4//电能表规格//MeterSpec=4 1.0  3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK_K1200_400_V41.*"
	#define FileUser_MS        "MS_K1200_400_V41.*"
	#define FileUser_OS        "OS_K1200_400_V41.*"
	#define FileUser_Meter     "Meter_K1200_400_V41.*"
	#define FileUser_Terminal  "Terminal_K1200_400_V41.*"
	#define FileUser_Menu      "Menu_K1200_400_V41.*"
	#define FileUser_Font      "Font_K1200_400_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_K1200_400_V41.*"

//FTP用文件名
	#define FileFTP_PACK      "PACK_K1200_400_V41.zip"
	#define FileFTP_MS        "MS_K1200_400_V41.zip"
	#define FileFTP_OS        "OS_K1200_400_V41.zip"
	#define FileFTP_Meter     "Meter_K1200_400_V41.zip"
	#define FileFTP_Terminal  "Terminal_K1200_400_V41.zip"
	#define FileFTP_Menu      "Menu_K1200_400_V41.zip"
	#define FileFTP_Font      "Font_K1200_400_V41.zip"
	#define FileFTP_MODULE    "Module_K1200_400_V41.zip"
...
#define FileUserDIR          "/K1200"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_000_V50.zip"
	#define FileUser_MS        "MS376N_K1200_000_V50.zip"
	#define FileUser_OS        "OS376N_K1200_000_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_000_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_000_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_000_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "ModuleN_K1200_000_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_000_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_000_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_000_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_000_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_000_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_000_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_000_V50.zip"
#endif

#if MeterSpec==1//电能表规格//MeterSpec=1 0.5S 3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_100_V50.zip"
	#define FileUser_MS        "MS376N_K1200_100_V50.zip"
	#define FileUser_OS        "OS376N_K1200_100_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_100_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_100_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_100_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module376N_K1200_100_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_100_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_100_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_100_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_100_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_100_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_100_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_100_V50.zip"
#endif

#if MeterSpec==2//电能表规格//MeterSpec=2 0.5S 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_200_V50.zip"
	#define FileUser_MS        "MS376N_K1200_200_V50.zip"
	#define FileUser_OS        "OS376N_K1200_200_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_200_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_200_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_200_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module376N_K1200_200_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_200_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_200_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_200_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_200_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_200_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_200_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_200_V50.zip"
#endif

#if MeterSpec==3//电能表规格//MeterSpec=3 1.0 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_300_V50.zip"
	#define FileUser_MS        "MS376N_K1200_300_V50.zip"
	#define FileUser_OS        "OS376N_K1200_300_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_300_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_300_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_300_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module376N_K1200_300_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_300_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_300_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_300_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_300_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_300_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_300_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_300_V50.zip"
#endif

#if MeterSpec==4//电能表规格//MeterSpec=4   1.0 3P3W 50Hz 20000imp/kWh 100V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_400_V50.zip"
	#define FileUser_MS        "MS376N_K1200_400_V50.zip"
	#define FileUser_OS        "OS376N_K1200_400_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_400_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_400_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_400_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module376N_K1200_400_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_400_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_400_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_400_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_400_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_400_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_400_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_400_V50.zip"
#endif

#if MeterSpec==5//电能表规格//MeterSpec=5   1.0 3P4W 50Hz 20000imp/kWh 57.7V 1.5(6)A
	#define FileUser_PACK      "PACK376N_K1200_500_V50.zip"
	#define FileUser_MS        "MS376N_K1200_500_V50.zip"
	#define FileUser_OS        "OS376N_K1200_500_V50.zip"
	#define FileUser_Meter     "Meter376N_K1200_500_V50.zip"
	#define FileUser_Terminal  "Terminal376N_K1200_500_V50.zip"
	#define FileUser_Menu      "Menu376N_K1200_500_V50.zip"
	#define FileUser_Font      "FontN.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module376N_K1200_500_V50.zip"

//FTP用文件名
	#define FileFTP_PACK      "PACK376N_K1200_500_V50.zip"
	#define FileFTP_MS        "MS376N_K1200_500_V50.zip"
	#define FileFTP_OS        "OS376N_K1200_500_V50.zip"
	#define FileFTP_Meter     "Meter376N_K1200_500_V50.zip"
	#define FileFTP_Terminal  "Terminal376N_K1200_500_V50.zip"
	#define FileFTP_Menu      "Menu376N_K1200_500_V50.zip"
	#define FileFTP_Font      "FontN.zip"
	#define FileFTP_MODULE    "Module376N_K1200_500_V50.zip"
#endif
