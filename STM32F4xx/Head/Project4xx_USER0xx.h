...
#define E1_UpDataMeterInit     0//E1软件更新仪表初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4=参数(除与系统主站通信有关的)及全体数据区初始化,5=参数及全体数据区初始化(即恢复至出厂配置)后硬件复位,6=仅部份参数初始化
#define E1_UpDataTerminalInit     0//E1软件更新终端初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4=参数(除与系统主站通信有关的)及全体数据区初始化,5=参数及全体数据区初始化(即恢复至出厂配置)后硬件复位,6=仅部份参数初始化
...
#define SVER     0x200//软件版本号:2.00
#define SVDATE     0x120828//软件发行日期:年月日
#define HVER     0x200//硬件版本号:2.00
#define HVDATE     0x120828//硬件发行日期:年月日
...
#define MaxSwitchInPort     2//最大开关量输入端口数(<=8,开关量输入端口数+门接点)
...
#define MaxRMDateCongeal     12//最大抄表日冻结数
...
#define RouterCheckTimerVal     (60*10)//载波路由器死机秒定时值
