...
#define Week_on   0  //福建新团体标准更改参数、上报及招读的时标为带星期格式   0无星期,1带星期(通过计算得到)
#define AutoFuJAFN57    0//福建上报格式: 团体标准 0=AFN0BF21和AFN0BF28, 福建规约 1=AFN57F1和AFN57F2
																					//执行与上报采用暂停时间控制, 原福建采用标志位控制
#define ComTest     0x1FF  //   0  //0x1ff//0x1F//福建232口与485口输出数据调试程序开关：0==关闭;其它==开启
//0x100
//0x80   485任务
//0x40   GPRS
//0x20   AFN56
...
#define Terminal_UpDataInit     3//0//软件更新初始化:0=否,1=硬件初始化,2=数据区初始化,3=参数及全体数据区初始化(即恢复至出厂配置),4/5=参数(除与系统主站通信有关的)及全体数据区初始化,6=仅部份参数初始化
...
#define EnUSER     1//1//0=否,1=是;软件更新时是否判别用户标识
...
#ifdef IC_STM32F4xx
#define HVER     0x410//硬件版本号:4.00
#if (HVER==0x400)
#define SVER     0x132//软件版本号:    //1.32     0x200//软件版本号:2.00
#define SVDATE     0x180510//0x180412//0x180117//软件发行日期:年月日   福建增补正式版
...
#define SVDATE     0x180626//0x180517//0x170323//软件发行日期:年月日
//#define HVER     0x410//硬件版本号:4.10
#define HVDATE     0x160701//硬件发行日期:年月日
#endif
#endif
...
#define SVDATE   0x190629//软件发行日期:年月日
	#ifndef LINUX
...
#define FTP_LEN_DATABUFF     1024//读写数据缓冲长度,最小4096
...
#define RMM_DateCongeal_0xEE     0//2类数据日冻结没抄到电表日冻结数据前填0xff;0=否(用实时数据冻结),1=是
#define RMM_MonthCongeal_0xEE     0//2类数据月冻结没抄到电表月冻结数据前填0xff;0=否(用实时数据冻结),1=是
		...
		#endif
	#endif
#define RMM_MonthCongealUserDate1     0//2类数据当月冻结使用电表每月1日冻结的数据;0=否,1=是;
...
#define DateRMTask        0//每日抄表任务;0=没有,1=有
#define WeekRMTask        0//每周抄表任务;0=没有,1=有(载波修改为当抄表失败时为加快任务退出不抄后续数据项)
#define TimerRMTask        0//定时抄读停电记录任务;0=没有,1=有
#define HourTask     0//重点户曲线抄读(仅对无曲线冻结的单相表)
#define MeterEventRMTask     1//周期抄读电能表事件任务;0=没有,1=有

#define RMM_RS485     0//RS485通道抄表模式:0=循抄全部数据,1=按大小类号设置抄读数据
#define RMM_RS485_DateCongeal     0//RS485通道抄表抄日冻结;0=否,1=是
#define RMM_Carrier_DateCongeal     0//载波通道抄表抄日冻结;0=否,1=是
#define RMM_RS485_IntegralCongeal     0//RS485通道抄表抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
#define RMM_Carrier_IntegralCongeal     0//载波通道抄表抄电表上1-24整点或曲线冻结;0=否,1=上1-24整点,2=曲线
...
#define MaxKeyUser     20//10//最大集中抄表重点用户数
#define MaxCarrierUser     1500//1600//最大载波抄表数(4的整数倍)
...
#define WaitHeartberatACKMaxTimer     240//180//600//心跳发出等待主站确认最大定时秒
#define WaitHostACKMinTimer     5//主动上报等待主站确认最小定时秒
#define WaitHostACKMaxTimer     180//120//60//主动上报等待主站确认最大定时秒
...
#define SoftBug4     1//0=正常功能,1=电科院送检(鼎信东软模块自动搜表为送检模式)
#define RMM_Type     0//集中抄表类型:0=载波表,1=RS485表通过采集器,2=混合
#define ErrorAutoDisplay     1//0=允许,1=禁止;系统错误自动立即显示
...
#define DefaultClassNo     0x00//自动搜表默认的用户大类号小类号
...
//用户目录全名
#define FileUserDIR          "/J1400"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J1400_000_V4.*"
	#define FileUser_MS        "MS_J1400_000_V4.*"
	#define FileUser_OS        "OS_J1400_000_V4.*"
	#define FileUser_Meter     "Meter_J1400_000_V4.*"
	#define FileUser_Terminal  "Terminal_J1400_000_V4.*"
	#define FileUser_Menu      "Menu_J1400_000_V4.*"
	#define FileUser_Font      "Font_J1400_000_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J1400_000_V4.*"
	#define FileUser_PLC_50    "PLC_J1400_000_V4_50.*"
	#define FileUser_PLC_TC    "PLC_J1400_000_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_J1400_000_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_J1400_000_V4_CX.*"
	#define FileUser_PLC_01    "PLC_J1400_000_V4_01.*"
	#define FileUser_PLC_LH    "PLC_J1400_000_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_J1400_000_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_J1400_000_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_J1400_000_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_J1400_000_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_J1400_000_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_J1400_000_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J1400_000_V4.zip"
	#define FileFTP_MS        "MS_J1400_000_V4.zip"
	#define FileFTP_OS        "OS_J1400_000_V4.zip"
	#define FileFTP_Meter     "Meter_J1400_000_V4.zip"
	#define FileFTP_Terminal  "Terminal_J1400_000_V4.zip"
	#define FileFTP_Menu      "Menu_J1400_000_V4.zip"
	#define FileFTP_Font      "Font_J1400_000_V4.zip"
	#define FileFTP_MODULE    "Module_J1400_000_V4.zip"
	#define FileFTP_PLC_50    "PLC_J1400_000_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_000_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_000_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_000_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_000_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_000_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_000_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_000_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_000_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_000_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_000_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_000_V4_SR.zip"
#endif
#if MeterSpec==3//电能表规格//MeterSpec=3 1.0  3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J1400_300_V4.*"
	#define FileUser_MS        "MS_J1400_300_V4.*"
	#define FileUser_OS        "OS_J1400_300_V4.*"
	#define FileUser_Meter     "Meter_J1400_300_V4.*"
	#define FileUser_Terminal  "Terminal_J1400_300_V4.*"
	#define FileUser_Menu      "Menu_J1400_300_V4.*"
	#define FileUser_Font      "Font_J1400_300_V4.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J1400_300_V4.*"
	#define FileUser_PLC_50    "PLC_J1400_300_V4_50.*"
	#define FileUser_PLC_TC    "PLC_J1400_300_V4_TC.*"
	#define FileUser_PLC_ES    "PLC_J1400_300_V4_ES.*"
	#define FileUser_PLC_CX    "PLC_J1400_300_V4_CX.*"
	#define FileUser_PLC_01    "PLC_J1400_300_V4_01.*"
	#define FileUser_PLC_LH    "PLC_J1400_300_V4_LH.*"
	#define FileUser_PLC_NX    "PLC_J1400_300_V4_NX.*"
	#define FileUser_PLC_QL    "PLC_J1400_300_V4_QL.*"
	#define FileUser_PLC_MX    "PLC_J1400_300_V4_MX.*"
	#define FileUser_PLC_FC    "PLC_J1400_300_V4_FC.*"
	#define FileUser_PLC_NW    "PLC_J1400_300_V4_NW.*"
	#define FileUser_PLC_SR    "PLC_J1400_300_V4_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J1400_300_V4.zip"
	#define FileFTP_MS        "MS_J1400_300_V4.zip"
	#define FileFTP_OS        "OS_J1400_300_V4.zip"
	#define FileFTP_Meter     "Meter_J1400_300_V4.zip"
	#define FileFTP_Terminal  "Terminal_J1400_300_V4.zip"
	#define FileFTP_Menu      "Menu_J1400_300_V4.zip"
	#define FileFTP_Font      "Font_J1400_300_V4.zip"
	#define FileFTP_MODULE    "Module_J1400_300_V4.zip"
	#define FileFTP_PLC_50    "PLC_J1400_300_V4_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_300_V4_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_300_V4_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_300_V4_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_300_V4_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_300_V4_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_300_V4_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_300_V4_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_300_V4_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_300_V4_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_300_V4_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_300_V4_SR.zip"
#endif
...
#define FileUserDIR          "/J1400"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J1400_000_V41.*"
	#define FileUser_MS        "MS_J1400_000_V41.*"
	#define FileUser_OS        "OS_J1400_000_V41.*"
	#define FileUser_Meter     "Meter_J1400_000_V41.*"
	#define FileUser_Terminal  "Terminal_J1400_000_V41.*"
	#define FileUser_Menu      "Menu_J1400_000_V41.*"
	#define FileUser_Font      "Font_J1400_000_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J1400_000_V41.*"
	#define FileUser_PLC_50    "PLC_J1400_000_V41_50.*"
	#define FileUser_PLC_TC    "PLC_J1400_000_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_J1400_000_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_J1400_000_V41_CX.*"
	#define FileUser_PLC_01    "PLC_J1400_000_V41_01.*"
	#define FileUser_PLC_LH    "PLC_J1400_000_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_J1400_000_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_J1400_000_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_J1400_000_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_J1400_000_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_J1400_000_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_J1400_000_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J1400_000_V41.zip"
	#define FileFTP_MS        "MS_J1400_000_V41.zip"
	#define FileFTP_OS        "OS_J1400_000_V41.zip"
	#define FileFTP_Meter     "Meter_J1400_000_V41.zip"
	#define FileFTP_Terminal  "Terminal_J1400_000_V41.zip"
	#define FileFTP_Menu      "Menu_J1400_000_V41.zip"
	#define FileFTP_Font      "Font_J1400_000_V41.zip"
	#define FileFTP_MODULE    "Module_J1400_000_V41.zip"
	#define FileFTP_PLC_50    "PLC_J1400_000_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_000_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_000_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_000_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_000_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_000_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_000_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_000_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_000_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_000_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_000_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_000_V41_SR.zip"
#endif
#if MeterSpec==3//电能表规格//MeterSpec=3 1.0  3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACK_J1400_300_V41.*"
	#define FileUser_MS        "MS_J1400_300_V41.*"
	#define FileUser_OS        "OS_J1400_300_V41.*"
	#define FileUser_Meter     "Meter_J1400_300_V41.*"
	#define FileUser_Terminal  "Terminal_J1400_300_V41.*"
	#define FileUser_Menu      "Menu_J1400_300_V41.*"
	#define FileUser_Font      "Font_J1400_300_V41.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "Module_J1400_300_V41.*"
	#define FileUser_PLC_50    "PLC_J1400_300_V41_50.*"
	#define FileUser_PLC_TC    "PLC_J1400_300_V41_TC.*"
	#define FileUser_PLC_ES    "PLC_J1400_300_V41_ES.*"
	#define FileUser_PLC_CX    "PLC_J1400_300_V41_CX.*"
	#define FileUser_PLC_01    "PLC_J1400_300_V41_01.*"
	#define FileUser_PLC_LH    "PLC_J1400_300_V41_LH.*"
	#define FileUser_PLC_NX    "PLC_J1400_300_V41_NX.*"
	#define FileUser_PLC_QL    "PLC_J1400_300_V41_QL.*"
	#define FileUser_PLC_MX    "PLC_J1400_300_V41_MX.*"
	#define FileUser_PLC_FC    "PLC_J1400_300_V41_FC.*"
	#define FileUser_PLC_NW    "PLC_J1400_300_V41_NW.*"
	#define FileUser_PLC_SR    "PLC_J1400_300_V41_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACK_J1400_300_V41.zip"
	#define FileFTP_MS        "MS_J1400_300_V41.zip"
	#define FileFTP_OS        "OS_J1400_300_V41.zip"
	#define FileFTP_Meter     "Meter_J1400_300_V41.zip"
	#define FileFTP_Terminal  "Terminal_J1400_300_V41.zip"
	#define FileFTP_Menu      "Menu_J1400_300_V41.zip"
	#define FileFTP_Font      "Font_J1400_300_V41.zip"
	#define FileFTP_MODULE    "Module_J1400_300_V41.zip"
	#define FileFTP_PLC_50    "PLC_J1400_300_V41_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_300_V41_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_300_V41_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_300_V41_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_300_V41_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_300_V41_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_300_V41_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_300_V41_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_300_V41_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_300_V41_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_300_V41_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_300_V41_SR.zip"
#endif
...
#define MaxFileNum     8//最大下载文件个数
//生产目录文件名
	#define FileFactory_PACK          "PACKN.zip"
	#define FileFactory_MS            "MSN.zip"
	#define FileFactory_OS            "OSN.zip"
	#define FileFactory_Meter         "MeterN.zip"
	#define FileFactory_Terminal      "TerminalN.zip"
	#define FileFactory_Menu          "MenuN.zip"
	#define FileFactory_Font          "FontN.zip"
	#define FileFactory_Font_ttf      "*.ttf"
	#define FileFactory_Test          "TestN.zip"
	#define FileFactory_Modele        "ModuleN.zip"
	...
	#define FileFactory_PACKB          "PACKN.bin"
	#define FileFactory_MSB            "MSN.bin"
	#define FileFactory_OSB            "OSN.bin"
	#define FileFactory_MeterB         "MeterN.bin"
	#define FileFactory_TerminalB      "TerminalN.bin"
	#define FileFactory_MenuB          "MenuN.bin"
	#define FileFactory_FontB          "FontN.bin"
//	#define FileFactory_Font_ttf      "*.ttf"
	#define FileFactory_TestB          "TestN.bin"
	#define FileFactory_ModeleB        "ModuleN.bin"
	
//用户目录全名
#define FileUserDIR          "/J1400"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACKN_J1400_000_V50.zip"
	#define FileUser_MS        "MSN_J1400_000_V50.zip"
	#define FileUser_OS        "OSN_J1400_000_V50.zip"
	#define FileUser_Meter     "MeterN_J1400_000_V50.zip"
	#define FileUser_Terminal  "TerminalN_J1400_000_V50.zip"
	#define FileUser_Menu      "MenuN_J1400_000_V50.zip"
	#define FileUser_Font      "FontN_J1400_000_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "ModuleN_J1400_000_V50.zip"
	#define FileUser_PLC_50    "PLC_J1400_000_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_J1400_000_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_J1400_000_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_J1400_000_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_J1400_000_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_J1400_000_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_J1400_000_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_J1400_000_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_J1400_000_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_J1400_000_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_J1400_000_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_J1400_000_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACKN_J1400_000_V50.zip"
	#define FileFTP_MS        "MSN_J1400_000_V50.zip"
	#define FileFTP_OS        "OSN_J1400_000_V50.zip"
	#define FileFTP_Meter     "MeterN_J1400_000_V50.zip"
	#define FileFTP_Terminal  "TerminalN_J1400_000_V50.zip"
	#define FileFTP_Menu      "MenuN_J1400_000_V50.zip"
	#define FileFTP_Font      "FontN_J1400_000_V50.zip"
	#define FileFTP_MODULE    "ModuleN_J1400_000_V50.zip"
	#define FileFTP_PLC_50    "PLC_J1400_000_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_000_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_000_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_000_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_000_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_000_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_000_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_000_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_000_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_000_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_000_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_000_V50_SR.zip"
#endif

#if MeterSpec==3//电能表规格//MeterSpec=0 1.0 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACKN_J1400_300_V50.zip"
	#define FileUser_MS        "MSN_J1400_300_V50.zip"
	#define FileUser_OS        "OSN_J1400_300_V50.zip"
	#define FileUser_Meter     "MeterN_J1400_300_V50.zip"
	#define FileUser_Terminal  "TerminalN_J1400_300_V50.zip"
	#define FileUser_Menu      "MenuN_J1400_300_V50.zip"
	#define FileUser_Font      "FontN_J1400_300_V50.zip"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "ModuleN_J1400_300_V50.zip"
	#define FileUser_PLC_50    "PLC_J1400_300_V50_50.zip"
	#define FileUser_PLC_TC    "PLC_J1400_300_V50_TC.zip"
	#define FileUser_PLC_ES    "PLC_J1400_300_V50_ES.zip"
	#define FileUser_PLC_CX    "PLC_J1400_300_V50_CX.zip"
	#define FileUser_PLC_01    "PLC_J1400_300_V50_01.zip"
	#define FileUser_PLC_LH    "PLC_J1400_300_V50_LH.zip"
	#define FileUser_PLC_NX    "PLC_J1400_300_V50_NX.zip"
	#define FileUser_PLC_QL    "PLC_J1400_300_V50_QL.zip"
	#define FileUser_PLC_MX    "PLC_J1400_300_V50_MX.zip"
	#define FileUser_PLC_FC    "PLC_J1400_300_V50_FC.zip"
	#define FileUser_PLC_NW    "PLC_J1400_300_V50_NW.zip"
	#define FileUser_PLC_SR    "PLC_J1400_300_V50_SR.zip"
//FTP用文件名
	#define FileFTP_PACK      "PACKN_J1400_300_V50.zip"
	#define FileFTP_MS        "MSN_J1400_300_V50.zip"
	#define FileFTP_OS        "OSN_J1400_300_V50.zip"
	#define FileFTP_Meter     "MeterN_J1400_300_V50.zip"
	#define FileFTP_Terminal  "TerminalN_J1400_300_V50.zip"
	#define FileFTP_Menu      "MenuN_J1400_300_V50.zip"
	#define FileFTP_Font      "FontN_J1400_300_V50.zip"
	#define FileFTP_MODULE    "ModuleN_J1400_300_V50.zip"
	#define FileFTP_PLC_50    "PLC_J1400_300_V50_50.zip"
	#define FileFTP_PLC_TC    "PLC_J1400_300_V50_TC.zip"
	#define FileFTP_PLC_ES    "PLC_J1400_300_V50_ES.zip"
	#define FileFTP_PLC_CX    "PLC_J1400_300_V50_CX.zip"
	#define FileFTP_PLC_01    "PLC_J1400_300_V50_01.zip"
	#define FileFTP_PLC_LH    "PLC_J1400_300_V50_LH.zip"
	#define FileFTP_PLC_NX    "PLC_J1400_300_V50_NX.zip"
	#define FileFTP_PLC_QL    "PLC_J1400_300_V50_QL.zip"
	#define FileFTP_PLC_MX    "PLC_J1400_300_V50_MX.zip"
	#define FileFTP_PLC_FC    "PLC_J1400_300_V50_FC.zip"
	#define FileFTP_PLC_NW    "PLC_J1400_300_V50_NW.zip"
	#define FileFTP_PLC_SR    "PLC_J1400_300_V50_SR.zip"
#endif
#endif
//硬件版本5.00结束----------------------------------------------------------------------------------
