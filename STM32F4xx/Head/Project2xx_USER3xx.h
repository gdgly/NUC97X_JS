...
#define SVDATE     0x140103//软件发行日期:年月日
...
#define MaxKeyUser     300//10//最大集中抄表重点用户数
#define MaxCarrierUser     1016//1680//最大载波抄表数(4的整数倍)
...
#define RS232AutoRePort     1//RS232口主动上报0=禁止,1=允许
