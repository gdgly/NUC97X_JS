...
;//在PC中进行替换
	...
	DCD 0;//125//SAME_MS+(SAME_OS<<1)+(SAME_Meter<<2)+(SAME_Terminal<<3)+(SAME_Test<<4)+(SAME_Font<<5),//同时更新标志:B0=MS,B1=OS,B2=Meter,B3=Terminal,B4=Test,5=Font,6=,7=Router
	DCD 0;//126//DEBUG,// 0=发行,1=调试
	DCD 0;//127//MeterCtrl+(MeterType<<8)+(MeterSpec<<16);//电能表常数接线方式等电能表规格
	DCD 8;//128//软件号:0=MS,1=OS,2=Meter,3=Terminal,4=Test,5=Font,6=PACK,7=Router,8=TEST
