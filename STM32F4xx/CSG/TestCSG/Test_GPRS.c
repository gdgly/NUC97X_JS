...
u32 Test_GPRS_MODULE(u32 ADDR_BASE)//GPRS模块,载波模块或控制模块
{
...
#if (Project/100)==3 ||(Project/100)==9  //方案0=智能表,100=网络表,200=集中器,300=专变终端,400=公变终端,500=集中器Ⅱ型,600=通信模块,700=
	...
	#endif
	#if (Project/100)==9//方案0=智能表,100=网络表,200=集中器,300=专变终端,400=公变终端,500=集中器Ⅱ型,600=通信模块,700=
	DisplayStringAutoUp(0,9,(u8*)"\x0""LOCAL MODULE");//显示字符串自动向上平移;出口:修改下一显示行并寄存在ADDR_AutoRowCol
	#endif
	__enable_irq();//允许中断
	Comm_Ram->GPMSTimer=60000/10;
