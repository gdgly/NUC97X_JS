...
//---通信类---
#define ADDR_4001     ADDR_QCSG_SET_START//通信地址
//属性2∷=octet-string
...
#define ADDR_F200_2     ADDR_4510_5+LENmax_4510_5//RS232
//端口∷=structure
//{
//端口号     OAD
//端口参数   COMDCB，
...
#define ADDR_DL698_COMSET_END     ADDR_F202_2+LENmax_F202_2
//---通信类结束---
...
#define LENmax_EventOAD     82//2+(5*NUMmax_EventOAD)
	...
	#error
#endif
#define ADDR_3000     ADDR_DL698_COMSET_END//电能表失压事件
//有效标识∷=bool
//上报标识∷=enum
//{
//不上报（0），
...
#define ADDR_8001_127     ADDR_8001_5+LENmax_8001_5//方法127：投入保电
...
#define NUMmax_8103_2     NUMmax_TAG
...
#define ADDR_8103_127     ADDR_8103_3+LENmax_8103_3//时段功控-方案切换(初始化值0x00)
//array
//时段功控方案切换∷=structure
//总加组对象∷=OI
//控制方案∷=structure
...
#define LENmax_8103_127     (2+(LENper_8103_127*NUMmax_8103_2))
...
#define NUMmax_8104_2     NUMmax_TAG
...
#define NUMmax_8105_2     NUMmax_TAG
...
#define NUMmax_8106_127     NUMmax_TAG
...
#define NUMmax_8107_2     NUMmax_TAG
...
#define NUMmax_8108_2     NUMmax_TAG
...
#define ADDR_F209_128     ADDR_F207_127+LENmax_F207_127//载波/微功率无线接口
...
#define ADDR_F001_4     ADDR_F20B_127+LENmax_F20B_127//文件传输块状态字
...
#define ADDR_F001_7     ADDR_F001_4+LENmax_F001_4//文件分块传输管理
//方法7：启动传输（参数）
//参数∷=structure
//{
//	文件信息∷=structure
...
#define ADDR_QCSG_SET_END     ADDR_F002_8+LENmax_F002_8

#if ((ADDR_DL698_SET_END)-(ADDR_QCSG_SET_START)) > LEN_FLASH_QCSG_SET
