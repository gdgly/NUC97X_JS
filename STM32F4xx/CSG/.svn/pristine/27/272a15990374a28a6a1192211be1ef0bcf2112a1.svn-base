...
const u32 ADDR_Menu_VER[]=//版本信息
{
//VER
	EnProject+(EnHV<<1)+(EnUSER<<2)+(EnSV<<3)+(EnMeter<<4),//软件更新时是否判别
	Project,//方案0=智能表,100=网络表,200=集中器,300=专变终端,400=,500=集中器Ⅱ型,600=,700=
	HVER,//硬件版本号
	USER,//用户标识
	SVER,//软件版本号
#if SAME_Meter==0//0=否,1=是;软件需同时更新标志
	0,
#else
	...
	4,//软件号:0=MS,1=OS,2=Meter,3=Terminal,4=Menu,5=Font,6=,7=Router,8=Test
