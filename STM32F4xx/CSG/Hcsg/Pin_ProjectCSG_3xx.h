...
#define PIN_DAC1     		(0<<8)+4		//err20181108 CT二次开路 波形输出口
#define PIN_BV7_A5V	     	(0<<8)+5		// 计量芯片 5.0V 电压检测
#define PIN_BV1_E3V3     	(0<<8)+6		// 以太网 3.3V 电压检测
...
// 1(B)
#define PIN_BV5_V3V6   		(1<<8)+0		// 时钟电池 3.6V 电压检测
#define PIN_BV6_V4V8   		(1<<8)+1		// 后备电池 4.8V 电压检测
...
#define PIN_GPRS_ID0   		(1<<8)+7        // GPRS_ID0
#define PIN_GPRS_ID1   		(1<<8)+8        // GPRS_ID1
...
#define PIN_BV3_V5V   		(2<<8)+3		// 主电源 5.0V 电压检测
...
#define PIN_TERMINAL_KG		(2<<8)+9		// 终端开盖检测
#define PIN_UART4_TX   		(2<<8)+10
#define PIN_UART4_RX   		(2<<8)+11
...
#define PIN_UART5_OE   		(3<<8)+3		//  RS485通道 1 收发控制
...
#define PIN_SWITCH_OUT1		(4<<8)+2
#define PIN_SWITCH_OUT2     (4<<8)+3
#define PIN_SWITCH_OUT3     (4<<8)+4
#define PIN_SWITCH_OUT4     (4<<8)+5
#define PIN_ALARM_OUT  		(4<<8)+6
...
#define PIN_CT_A_CHK		(5<<8)+9		//err20181108 CT二次开路 ADC3_IN7     通道输入  	 // PIN_NEXTI
#define PIN_CT_B_CHK     	(5<<8)+10		//err20181108 CT二次开路 ADC3_IN8     通道输入  	 // PIN_NEXTD
...
#define PIN_IR_RXD     		(6<<8)+2		// PIN_FMC_A12     	(6<<8)+2		
#define PIN_IR_TXD    		(6<<8)+3		// PIN_FMC_A13
#define PIN_FMC_BA0     	(6<<8)+4
#define PIN_FMC_BA1     	(6<<8)+5
#define PIN_PLC_ID     		(6<<8)+6		// not use in FK
#define PIN_YX_RST     		(6<<8)+7		// 遥信模块复位
#define PIN_FMC_SDCLK     	(6<<8)+8
#define PIN_FMC_NCE3   		(6<<8)+9		// NAND flash CS
#define PIN_FMC_NE3   		(6<<8)+10		// LCD CS
...
#define PIN_ENBACKLIGHT   	(7<<8)+7		// LCD 背光控制
#define PIN_ATTR_LED     	(7<<8)+8
#define PIN_ENHOT     		(7<<8)+9		// unkown
#define PIN_ETH_RST   		(7<<8)+10		// 
#define PIN_ENET_LINK_LED  	(7<<8)+11
#define PIN_ENR5V0   		(7<<8)+12		// GPRS 电源控制
#define PIN_ENUSB5V0   		(7<<8)+13		// USB 电源控制
#define PIN_EMURST   		(7<<8)+14		// 计量部分复位
#define PIN_ENA5V0   		(7<<8)+15		// 计量芯片部分电源控制
...
#define PIN_ENE5V0   		(8<<8)+4		// 以太网电源控制
#define PIN_GPRS_ID2     	(8<<8)+5		// GPRS_ID2
#define PIN_GPRS_ID3     	(8<<8)+6		// GPRS_ID3
#define PIN_GPRS_ID4     	(8<<8)+7		// GPRS_ID4
#define PIN_SPACE_PI8     	(8<<8)+8		
#define PIN_ENTER     		(8<<8)+9
#define PIN_LCD_RST   		(8<<8)+10		// 
#define PIN_UART7_OE   		(8<<8)+11		// RS485通道 2 收发控制
#define PIN_LEFT     		(8<<8)+12		// Key: Left
#define PIN_RIGHT     		(8<<8)+13		// key: Right
#define PIN_RUNLED   		(8<<8)+14		// 
#define PIN_ESC       		(8<<8)+15		// Key: ESC
// 9(J)
#define PIN_RS485R1_LED     (9<<8)+0
#define PIN_RS485T1_LED     (9<<8)+1
#define PIN_FUNIMP        	(9<<8)+2
#define PIN_SPACE_PJ3     	(9<<8)+3
#define PIN_SPACE_PJ4     	(9<<8)+4
#define PIN_USART3_OE     	(9<<8)+5		// RS485通道 3 收发控制
#define PIN_SPACE_PJ6		(9<<8)+6		
#define PIN_SPACE_PJ7     	(9<<8)+7		
#define PIN_CT_KEY    		(9<<8)+8		// err20181108 CT二次开路ADC通道信号开关 
#define PIN_NEXTD     		(9<<8)+9		// PIN_CT_B_CHK
#define PIN_SPACE_PJ10     	(9<<8)+10
#define PIN_NEXTI     		(9<<8)+11		// PIN_CT_A_CHK
#define PIN_ON_GPRS     	(9<<8)+12
#define PIN_GPRS_PCTRL     	(9<<8)+13
#define PIN_PROKEY    		(9<<8)+14
#define PIN_CTR_EN     		(9<<8)+15		//PIN_SPACE_PJ15

// 10(K)
#define PIN_CH_CTL1     	(10<<8)+0		//err20181108 CT2次开路输入通道选择
#define PIN_CH_CTL0     	(10<<8)+1		//err20181108 CT2次开路输入通道选择
#define PIN_SPACE_PK2     	(10<<8)+2
#define PIN_GPRS_RTS     	(10<<8)+3
#define PIN_GPRS_CTS     	(10<<8)+4
#define PIN_GPRS_DTR     	(10<<8)+5
#define PIN_RS485R2_LED     (10<<8)+6
#define PIN_RS485T2_LED     (10<<8)+7
