...
#define SVDATE     				0x170531	// 0x160812//软件发行日期:年月日
...
#define ADDR_OS_ENTRY        	0x08020000		// 256K
#define ADDR_Terminal_ENTRY  	0x08060000		// 512K
#define ADDR_Menu_ENTRY      	0x080E0000		// 128K
#define ADDR_Test_ENTRY      	ADDR_Menu_ENTRY	// 128K(同菜单入口和长度)

#define ADDR_Font_ENTRY      	0x080E0000		// 256K
#define ADDR_Meter_ENTRY     	0x080E0000		// 128K

#define LENmax_MS     		  	(64*1024)		//空间长度
#define LENmax_OS     		  	(256*1024)		//空间长度
#define LENmax_Font          	0		//空间长度
#define LENmax_Meter			  	0		//空间长度

#define LENmax_Terminal   		(512*1024)		//空间长度
#define LENmax_Menu       		(128*1024)		//空间长度
...
//用户目录全名
#define FileUserDIR          "/II000"
#if MeterSpec==0//电能表规格//MeterSpec=0 0.5S 3P4W 50Hz 6400imp/kWh 220V 1.5(6)A
	#define FileUser_PACK      "PACKQCSG_II000_000_V3.*"
	#define FileUser_MS        "MSQCSG_II000_000_V3.*"
	#define FileUser_OS        "OSQCSG_II000_000_V3.*"
	#define FileUser_Meter     "MeterQCSG_II000_000_V3.*"
	#define FileUser_Terminal  "TerminalQCSG_II000_000_V3.*"
	#define FileUser_Menu      "MenuQCSG_II000_000_V3.*"
	#define FileUser_Font      "Font_II000_000_V3.*"
	#define FileUser_Font_ttf  "*.ttf"
	#define FileUser_MODULE    "ModuleQCSG_II000_000_V3.*"
	#define FileUser_PLC_50    "PLC_II000_000_V3_50.*"
	#define FileUser_PLC_TC    "PLC_II000_000_V3_TC.*"
	#define FileUser_PLC_ES    "PLC_II000_000_V3_ES.*"
	#define FileUser_PLC_CX    "PLC_II000_000_V3_CX.*"
	#define FileUser_PLC_01    "PLC_II000_000_V3_01.*"
	#define FileUser_PLC_LH    "PLC_II000_000_V3_LH.*"
	#define FileUser_PLC_NX    "PLC_II000_000_V3_NX.*"
	#define FileUser_PLC_QL    "PLC_II000_000_V3_QL.*"
	#define FileUser_PLC_MX    "PLC_II000_000_V3_MX.*"
	#define FileUser_PLC_FC    "PLC_II000_000_V3_FC.*"
	#define FileUser_PLC_NW    "PLC_II000_000_V3_NW.*"
	#define FileUser_PLC_SR    "PLC_II000_000_V3_SR.*"
//FTP用文件名
	#define FileFTP_PACK      "PACKQCSG_II000_000_V3.zip"
	#define FileFTP_MS        "MSQCSG_II000_000_V3.zip"
	#define FileFTP_OS        "OSQCSG_II000_000_V3.zip"
	#define FileFTP_Meter     "MeterQCSG_II000_000_V3.zip"
	#define FileFTP_Terminal  "TerminalQCSG_II000_000_V3.zip"
	#define FileFTP_Menu      "MenuQCSG_II000_000_V3.zip"
	#define FileFTP_Font      "Font_II000_000_V3.zip"
	#define FileFTP_MODULE    "ModuleQCSG_II000_000_V3.zip"
	#define FileFTP_PLC_50    "PLC_II000_000_V3_50.zip"
	#define FileFTP_PLC_TC    "PLC_II000_000_V3_TC.zip"
	#define FileFTP_PLC_ES    "PLC_II000_000_V3_ES.zip"
	#define FileFTP_PLC_CX    "PLC_II000_000_V3_CX.zip"
	#define FileFTP_PLC_01    "PLC_II000_000_V3_01.zip"
	#define FileFTP_PLC_LH    "PLC_II000_000_V3_LH.zip"
	#define FileFTP_PLC_NX    "PLC_II000_000_V3_NX.zip"
	#define FileFTP_PLC_QL    "PLC_II000_000_V3_QL.zip"
	#define FileFTP_PLC_MX    "PLC_II000_000_V3_MX.zip"
	#define FileFTP_PLC_FC    "PLC_II000_000_V3_FC.zip"
	#define FileFTP_PLC_NW    "PLC_II000_000_V3_NW.zip"
	#define FileFTP_PLC_SR    "PLC_II000_000_V3_SR.zip"
#endif
