...
#define ADDR_Meter_EFLASH_Start     ADDR_DISK_End 		// (ADDR_Com_EFLASH_Start+LEN_Com_EFLASH)
	...
	#if (((Project/100)==2)||((Project/100)==3)||((Project/100)==4)|| ((Project/100)==9))		// 方案0=智能表,100=网络表,200=集中器,300=专变终端,400=公变终端,500=集中器Ⅱ型,600=通信模块,700=
...
#define LOG_1376_1     	1		// 0=没,1=有
#define LOG_1376_2     	1		// 0=没,1=有
#define LOG_1376_3     	1		// 0=没,1=有
