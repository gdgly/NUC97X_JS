...
__Vectors       DCD     0;__initial_sp               ;0 Top of Stack
                DCD     Menu_Main;//Reset_Handler              ;1 Reset Handler
	...
	DCD 376;109 //协议:0=协议无关,376=1376.1协议,698=698.45协议,645=645-2007协议

;入口
	extern _0
	extern Init_Menu;//启动初始化
	extern Init_Menu_SoftwareUpdate;//软件更新初始化
	extern ADDR_Menu_END
	extern ADDR_Menu_VER;//版本信息
		
	extern ADDR_Menu_SetInitLib_Start
	extern ADDR_Menu_SetInitLib_End
  DCD __Vectors ; 110: 软件模块开始地址
  DCD ADDR_Menu_END ; 111: 软件模块结束地址
	DCD Init_Menu ; 112: 软件模块起动初始化入口
  DCD Init_Menu_SoftwareUpdate; 113: 软件模块更新初始化入口
  DCD ADDR_Menu_VER ; 114: 版本信息
  DCD _0 ; 115
  DCD _0 ; 116:
  DCD _0 ; 117:
  DCD 0;ADDR_Menu_SetInitLib_Start ; 118://初始化库开始地址
  DCD 0;ADDR_Menu_SetInitLib_End ; 119://初始化库结束地址
...
;//在PC中进行替换
	...
	DCD 4;//128//软件号:0=MS,1=OS,2=Meter,3=Terminal,4=Menu,5=Font,6=,7=Router,8=Test
