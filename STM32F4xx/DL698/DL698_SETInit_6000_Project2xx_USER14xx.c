...
//通信地址  TSA，
	DataType_TSA,0x07,
	0x05,0x00,0x00,0x00,0x00,0x00,0x04,
//波特率    enum
//{
//300bps（0），  600bps（1），    1200bps（2），
//2400bps（3）， 4800bps（4），   7200bps（5），
...
//端口      OAD，
	DataType_OAD,
	0xF2,0x09,0x02,0x01, //RS485_4通信口号(集中器载波,专变控制模块)
//通信密码  octet-string，
	DataType_octet_string,
	6,
	0x00,0x00,0x00,0x00,0x00,0x00,
...
//通信地址  TSA，
	DataType_TSA,0x07,
	0x05,0x00,0x00,0x00,0x00,0x00,0x05,
//波特率    enum
//{
//300bps（0），  600bps（1），    1200bps（2），
//2400bps（3）， 4800bps（4），   7200bps（5），
...
//通信地址  TSA，
	DataType_TSA,0x07,
	0x05,0x00,0x00,0x00,0x00,0x00,0x06,
//波特率    enum
//{
//300bps（0），  600bps（1），    1200bps（2），
//2400bps（3）， 4800bps（4），   7200bps（5），
...
//通信地址  TSA，
	DataType_TSA,0x07,
	0x05,0x00,0x00,0x00,0x00,0x00,0x07,
//波特率    enum
//{
//300bps（0），  600bps（1），    1200bps（2），
//2400bps（3）， 4800bps（4），   7200bps（5），
...
//通信地址  TSA，
	DataType_TSA,0x07,
	0x05,0x00,0x00,0x00,0x00,0x00,0x09,
//波特率    enum
//{
//300bps（0），  600bps（1），    1200bps（2），
//2400bps（3）， 4800bps（4），   7200bps（5），
...
#endif//#if NUMmax_IMPIN!=0


//福建增补
const u8 InitData_6E00[]=
{
//属性2（外部设备数据采集模式）∷= enum
//{
//国网协议（0），
...
//{ 
//端口            OAD， 
	DataType_OAD,0x00000000,
//穿透优先级      unsigned，
	DataType_unsigned,0,
//}
};
const u8 InitData_6E33[]=
{
//属性2（事件上报方案 report plan）∷=structure
	DataType_structure,4,
//{
//上报通道          array OAD，
	DataType_array,1,
	DataType_OAD,0x45000200,
//上报优先级        unsigned，
	DataType_unsigned,0,
//上报响应超时时间  TI，
	DataType_TI,
