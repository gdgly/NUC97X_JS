					...
					{//ROAD
						...
						{//分钟冻结
							...
							{//单相
								...
								switch(OAD)
								{
									...
									case 0x00200201://3 反向有功总电能  
										OAD=0x00020000;//DL645-2007标识 返回数据格式：XXXXXX.XX
										break;
						        ...
						        OAD=0x02800004;//DL645-2007标识 返回数据格式：XX.XXXX
									...
									case 0x20010200://13 电流
										OAD=0x0202ff00;//DL645-2007标识 返回数据格式：A相XXX.XXX B相XXX.XXX C相XXX.XXX
										break;										
									case 0x20010201://13 A相电流
										OAD=0x02020100;//DL645-2007标识 返回数据格式：A相XXX.XXX 
										break;
							...
							{//三相
								UARTCtrl->RMCSDSubCountMax=1;//抄表CSD有子抄表个数(非DL698抄表规约库设定)
								UARTCtrl->RMROADCountMax=0;//抄表CSD的ROAD内有OAD最大个数(非DL698抄表规约库设定)
								UARTCtrl->RM_DI=0x06000001;//全部6类负荷曲线
								return (u8*)1;
							}
						}
					}
