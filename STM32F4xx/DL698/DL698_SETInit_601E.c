...
//日冻结类.C 相电压合格率
const u8 InitData_601E_50050200_10100200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x01,0x01,0xFF,0x00,//（上一结算日）正向有功最大需量及发生时间（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
const u8 InitData_601E_50050200_10200200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
//		数据列选择描述符  CSD，
	...
	0x50,0x05,0x02,0x00,//OAD
	1,//关联个数
	0x10,0x20,0x02,0x00,  //正向有功最大需量及发生时间	
//		规则描述  structrue
	DataType_structure,3,
//		{
//			AcqCmd_2007  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x01,0x02,0xFF,0x00,//（上一结算日）正向有功最大需量及发生时间（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,2,
	DataType_octet_string,2,0xA0,0x2F,//正向有功最大需量
	DataType_octet_string,2,0xB0,0x2F,//正向有功最大需量发生时间
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_10300200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
//		数据列选择描述符  CSD，
	...
	0x50,0x05,0x02,0x00,//OAD
	1,//关联个数
	0x10,0x30,0x02,0x00,  //正向有功最大需量及发生时间	
//		规则描述  structrue
	DataType_structure,3,
//		{
//			AcqCmd_2007  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x01,0x03,0xFF,0x00,//（上一结算日）正向有功最大需量及发生时间（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,2,
	DataType_octet_string,2,0xA1,0x1F,//正向有功最大需量
	DataType_octet_string,2,0xB1,0x1F,//正向有功最大需量发生时间
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_10400200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
//		数据列选择描述符  CSD，
	...
	0x50,0x05,0x02,0x00,//OAD
	1,//关联个数
	0x10,0x40,0x02,0x00,  //正向有功最大需量及发生时间	
//		规则描述  structrue
	DataType_structure,3,
//		{
//			AcqCmd_2007  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x01,0x04,0xFF,0x00,//（上一结算日）正向有功最大需量及发生时间（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,2,
	DataType_octet_string,2,0xA1,0x2F,//正向有功最大需量
	DataType_octet_string,2,0xB1,0x2F,//正向有功最大需量发生时间
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00100200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x01,0xFF,0x00,//（上一结算日）正向有功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x90,0x1F,//（上一结算日）正向有功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00200200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x02,0xFF,0x00,//（上一结算日）反向有功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x90,0x2F,//（上一结算日）反向有功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00300200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x03,0xFF,0x00,//（上一结算日）正向无功（组合无功1）电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x1F,//（上一结算日）正向无功（组合无功1）电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00400200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x04,0xFF,0x00,//（上一结算日）反向无功（组合无功2）电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x2F,//（上一结算日）反向无功（组合无功2）电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00500200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x05,0xFF,0x00,//（上一结算日）一象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x3F,//（上一结算日）一象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00600200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x06,0xFF,0x00,//（上一结算日）二象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x5F,//（上一结算日）二象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00700200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x07,0xFF,0x00,//（上一结算日）三象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x6F,//（上一结算日）三象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
const u8 InitData_601E_50050200_00800200[]=
{
//	属性2∷=structure
	DataType_structure,2,
//	{
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x00,0x08,0xFF,0x00,//（上一结算日）四象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(2))，
	DataType_array,1,
	DataType_octet_string,2,0x91,0x4F,//（上一结算日）四象限无功电能示值（总、费率1～M）
//				备用DI  array octet-string(SIZE(2))
	DataType_array,0,
//			}，
//			AcqCmd_Trans  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x03,0x10,0x01,0x01,//(上1月)A相电压合格率统计记录
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x03,0x10,0x02,0x01,//(上1月)B相电压合格率统计记录
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
//				主用DI  array octet-string(SIZE(4))，
	DataType_array,1,
	DataType_octet_string,4,0x03,0x10,0x03,0x01,//(上1月)C相电压合格率统计记录
//				备用DI  array octet-string(SIZE(4))
	DataType_array,0,
//			}，
//			AcqCmd_1997  structure
...
__align(4) const DL698_LIB_List_TypeDef SETINIT_601E_List[]=
{
//
...
#if(USER/100)==17//江苏系
	(u32*)InitData_601E_50050200_10100200,(u32*)sizeof(InitData_601E_50050200_10100200),//1正向有功最大需量及发生时间	
	(u32*)InitData_601E_50050200_10200200,(u32*)sizeof(InitData_601E_50050200_10200200),//2反向有功最大需量及发生时间		
	(u32*)InitData_601E_50050200_10300200,(u32*)sizeof(InitData_601E_50050200_10300200),//3组合无功I最大需量及发生时间	
	(u32*)InitData_601E_50050200_10400200,(u32*)sizeof(InitData_601E_50050200_10400200),//4组合无功II最大需量及发生时间			
	(u32*)InitData_601E_50050200_00100200,(u32*)sizeof(InitData_601E_50050200_00100200),//5正向有功电能			
	(u32*)InitData_601E_50050200_00200200,(u32*)sizeof(InitData_601E_50050200_00200200),//6反向有功电能
	(u32*)InitData_601E_50050200_00300200,(u32*)sizeof(InitData_601E_50050200_00300200),//7组合无功1电能			
	(u32*)InitData_601E_50050200_00400200,(u32*)sizeof(InitData_601E_50050200_00400200),//8组合无功1电能	
	(u32*)InitData_601E_50050200_00500200,(u32*)sizeof(InitData_601E_50050200_00500200),//9第一象限无功电能			
	(u32*)InitData_601E_50050200_00600200,(u32*)sizeof(InitData_601E_50050200_00600200),//10第二象限无功电能
	(u32*)InitData_601E_50050200_00700200,(u32*)sizeof(InitData_601E_50050200_00700200),//11第三象限无功电能			
	(u32*)InitData_601E_50050200_00800200,(u32*)sizeof(InitData_601E_50050200_00800200),//12第四象限无功电能	
