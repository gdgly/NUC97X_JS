...
//终端消息认证错误事件
#define Init_Enable_Event_3109     1//事件有效标识bool
#define Init_Report_Event_3109     3//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）
//设备故障记录
...
//电能量超差事件
#define Init_Enable_Event_310C     1//事件有效标识bool
#define Init_Report_Event_310C     3//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）
//电能表飞走事件
...
#define Init_Report_Event_3114     3//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）
//遥控跳闸记录
...
//电能表数据变更监控记录
#define Init_Enable_Event_311C     1//事件有效标识bool
#define Init_Report_Event_311C     3//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）
//功控跳闸记录
...
//扩展
//电表接线错误事件
#define Init_Enable_Event_3411     1//事件有效标识bool
#define Init_Report_Event_3411     3//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）


#else//#if USER==901//900=河南过电科院台体测试版(仅终端事件设置参数同国网电科院测试版)
...
//扩展
//电表接线错误事件
#define Init_Enable_Event_3411     0//事件有效标识bool
#define Init_Report_Event_3411     0//不上报（0）,事件发生上报（1），事件恢复上报（2），事件发生恢复均上报（3）
#endif//#if USER!=901//901=河南过电科院台体测试版(仅终端事件设置参数同国网电科院测试版)
...
//扩展
const u8 InitData_3411[]=//电表接线错误事件记录
{
//有效标识∷=bool
	DataType_bool,
	Init_Enable_Event_3411,
//上报标识∷=enum
//{
//不上报（0），
//事件发生上报（1），
...
//}
	DataType_enum,
	Init_Report_Event_3411,
//关联对象属性表∷=array OAD
	DataType_array,
	0,
};
const u8 InitData_3411_6[]=//电表接线错误事件记录-6
{
//属性6（配置参数）∷=structure
	DataType_structure,
	0,
