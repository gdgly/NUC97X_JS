...
const u8 InitData_6012_2_1[]=//任务配置1，实时采集任务
{
...
const u8 InitData_6012_2_2[]=//任务配置2，日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_4[]=//任务配置4，月采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_5[]=//任务配置5，15分钟曲线任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_6[]=//任务配置6，15分钟曲线任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_7[]=//任务配置7，日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_8[]=//任务配置8，抄表日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_9[]=//任务配置9，月采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_10[]=//任务配置10，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_11[]=//任务配置11，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_12[]=//任务配置12，日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_13[]=//任务配置13，抄表日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_14[]=//任务配置14，月采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_15[]=//任务配置15，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_16[]=//任务配置16，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_17[]=//任务配置17，日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_18[]=//任务配置18，抄表日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_19[]=//任务配置19，月采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_20[]=//任务配置20，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_21[]=//任务配置21，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_22[]=//任务配置22，日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_23[]=//任务配置23，抄表日采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_24[]=//任务配置24，月采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_25[]=//任务配置25，15分钟曲线采集任务
{
//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_26[] =//任务配置26，实时采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_27[] =//任务配置27，日采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_28[] =//任务配置28，月采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_29[] =//任务配置29，15分钟曲线采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_30[] =//任务配置30，60分钟曲线采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_31[] =//任务配置31，日采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_32[] =//任务配置32，月采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_33[] =//任务配置33，15分钟曲线采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_34[] =//任务配置34，1分钟曲线采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_35[] =//任务配置35，1级事件采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_36[] =//任务配置36，2级事件采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
const u8 InitData_6012_2_37[] =//任务配置37，3级事件采集任务
{
	//属性2（任务配置单元）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	12,
...
//【01】普通采集方案（公用配变关口，用户类型106）
#define InitData_6014_2_1_
const u8 InitData_6014_2_1[]=//实时采集方案
{
...
//记录列选择  array CSD，
	...
	DataType_CSD,
	0x00, 0x00, 0x11, 0x02, 0x00,//2	A 相正向有功
	DataType_CSD,
	0x00, 0x00, 0x12, 0x02, 0x00,//3	B 相正向有功
	DataType_CSD,
	0x00, 0x00, 0x13, 0x02, 0x00,//4	C 相正向有功
	DataType_CSD,
	0x00, 0x00, 0x20, 0x02, 0x00,//5 反向有功电能
	DataType_CSD,
	0x00, 0x00, 0x21, 0x02, 0x00,//6 A 相反向有功
	DataType_CSD,
	0x00, 0x00, 0x22, 0x02, 0x00,//7 B 相反向有功
	DataType_CSD,
	0x00, 0x00, 0x23, 0x02, 0x00,//8 C 相反向有功
	DataType_CSD,
	0x00, 0x00, 0x30, 0x02, 0x00,//9 组合无功1电能
	DataType_CSD,
	0x00, 0x00, 0x31, 0x02, 0x00,//10 A相组合无功1电能
	DataType_CSD,
	0x00, 0x00, 0x32, 0x02, 0x00,//11 B相组合无功1电能
	DataType_CSD,
	0x00, 0x00, 0x33, 0x02, 0x00,//12 C相组合无功1电能
	DataType_CSD,
	0x00, 0x00, 0x40, 0x02, 0x00,//13 组合无功2电能
	DataType_CSD,
	0x00, 0x00, 0x41, 0x02, 0x00,//14 A相组合无功2电能
	DataType_CSD,
	0x00, 0x00, 0x42, 0x02, 0x00,//15 B相组合无功2电能
	DataType_CSD,
	0x00, 0x00, 0x43, 0x02, 0x00,//16 C相组合无功2电能
	DataType_CSD,
	0x00, 0x00, 0x50, 0x02, 0x00,//17 一象限无功电能
	DataType_CSD,
	0x00, 0x00, 0x60, 0x02, 0x00,//18 二象限无功电能
	DataType_CSD,
	0x00, 0x00, 0x70, 0x02, 0x00,//19 三象限无功电能
	DataType_CSD,
	0x00, 0x00, 0x80, 0x02, 0x00,//20 四象限无功电能	
	DataType_CSD,
	0x00, 0x10, 0x10, 0x02, 0x00,//21 正向有功最大需量及发生时间
	DataType_CSD,
	0x00, 0x10, 0x20, 0x02, 0x00,//22 反向有功最大需量及发生时间
	DataType_CSD,
	0x00, 0x10, 0x30, 0x02, 0x00,//23 组合无功1最大需量及发生时间
	DataType_CSD,
	0x00, 0x10, 0x40, 0x02, 0x00,//24 组合无功2最大需量及发生时间
	DataType_CSD,
	0x00, 0x20, 0x00, 0x02, 0x00,//25 电压
	DataType_CSD,
	0x00, 0x20, 0x01, 0x02, 0x00,//26 电流
	DataType_CSD,
	0x00,0x20,0x02,0x02,0x00,//27电压相角
	DataType_CSD,
	0x00,0x20,0x03,0x02,0x00,//28电压电流相角
	DataType_CSD,
	0x00, 0x20, 0x01, 0x04, 0x00,//29 零线电流（698表需要配置）
	DataType_CSD,
	0x00, 0x20, 0x04, 0x02, 0x00,//30 有功功率
	DataType_CSD,
	0x00, 0x20, 0x05, 0x02, 0x00,//31 无功功率
	DataType_CSD,
	0x00, 0x20, 0x06, 0x02, 0x00,//32视在功率
	DataType_CSD,
	0x00, 0x20, 0x0A, 0x02, 0x00,//33 功率因素	
	DataType_CSD,
	0x00, 0x20, 0x14, 0x02, 0x00,//34 电表运行状态字
	DataType_CSD,
	0x00, 0x40, 0x00, 0x02, 0x00,//35 日期时间
...
const u8 InitData_6014_2_2[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
	...
	*/
	...
	0x00, 0x10, 0x02, 0x00,// 正向有功
	0x00, 0x20, 0x02, 0x00,// 反向有功
...
const u8 InitData_6014_2_3[] =//抄表日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_4[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_5[]=//15分钟曲线采集方案
{
//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//记录列选择  array CSD，
	...
	0x00,0x30,0x02,0x00,//组合无功1 总电能
	0x00,0x40,0x02,0x00,//组合无功 2总电能
	DataType_CSD,
	0x01,0x50,0x02,0x02,0x00,
	4,
...
//【02】普通采集方案（低压三相一般工商业用户，用户类型22、24、33、34、35）
#define InitData_6014_2_6_
const u8 InitData_6014_2_6[]=//实时采集方案
{
//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//记录列选择  array CSD，
	...
	//DataType_CSD,
	//0x00, 0x20, 0x01, 0x04, 0x00,//17 零线电流（698表需要配置）
	DataType_CSD,
...
const u8 InitData_6014_2_7[]=//日采集方案
{
//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_8[] =//抄表日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_9[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_10[]=//15分钟曲线采集方案
{
//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【03】普通采集方案（低压单相一般工商业用户，用户类型52、54、57）
#define InitData_6014_2_11_
const u8 InitData_6014_2_11[] =//实时采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
	...
	*/
	...
	0x00, 0x00, 0x20, 0x02, 0x00,//2 反向有功电能
	DataType_CSD,
	0x00, 0x20, 0x00, 0x02, 0x00,//3 电压
	DataType_CSD,
	0x00, 0x20, 0x01, 0x02, 0x00,//4 电流
	DataType_CSD,
	0x00, 0x20, 0x04, 0x02, 0x00,//5 有功功率
	//电能表集合  MS，
	DataType_MS,
	0x02,	//一组用户类型	[2]  SEQUENCE OF unsigned
	3,52,54,57,
...
const u8 InitData_6014_2_12[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_13[] =//抄表日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_14[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_15[] =//15分钟曲线采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【04】普通采集方案（低压三相居民用户，用户类型72、74、87）
#define InitData_6014_2_16_
const u8 InitData_6014_2_16[] =//实时采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
	...
	*/
	...
	0x00, 0x20, 0x03, 0x02, 0x00,//16 电压电流相角
	DataType_CSD,
	0x00, 0x20, 0x04, 0x02, 0x00,//17 有功功率
	DataType_CSD,
	0x00, 0x20, 0x05, 0x02, 0x00,//18 无功功率
	DataType_CSD,
	0x00, 0x20, 0x06, 0x02, 0x00,//19 视在功率
	DataType_CSD,
	0x00, 0x20, 0x0A, 0x02, 0x00,//20 功率因素	
	DataType_CSD,
	0x00, 0x20, 0x14, 0x02, 0x00,//21 电表运行状态字
	DataType_CSD,
	0x00, 0x40, 0x00, 0x02, 0x00,//22 日期时间
	//电能表集合  MS，
	DataType_MS,
	0x02,	//一组用户类型	[2]  SEQUENCE OF unsigned
	3, 72,74,87,
...
const u8 InitData_6014_2_17[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_18[] =//抄表日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_19[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_20[] =//15分钟曲线采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【05】普通采集方案（低压单相居民用户，用户类型82、84、88）
#define InitData_6014_2_21_
const u8 InitData_6014_2_21[] =//实时采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_22[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_23[] =//抄表日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_24[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_25[] =//15分钟曲线采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【06】普通采集方案（低压光伏并网关口（单相），用户类型116）
#define InitData_6014_2_26_
const u8 InitData_6014_2_26[] =//实时采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
	...
	*/
	...
	0x00, 0x20, 0x04, 0x02, 0x00,//5 有功功率
	DataType_CSD,
	0x00, 0x20, 0x0A, 0x02, 0x00,//6 功率因数
...
const u8 InitData_6014_2_27[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_28[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_29[] =//15分钟曲线采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【07】普通采集方案（低压光伏并网关口（三相），用户类型115）
#define InitData_6014_2_30_
const u8 InitData_6014_2_30[] =//实时采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
	...
	*/
	...
	DataType_CSD,
	0x00, 0x20, 0x0A, 0x02, 0x00,//16 功率因数
...
const u8 InitData_6014_2_31[] =//日采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_32[] =//月采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
const u8 InitData_6014_2_33[] =//15分钟曲线采集方案
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
//【08】普通采集方案（8-分钟冻结采集器或STA）
#define InitData_6014_2_34_
const u8 InitData_6014_2_34[] =
{
	//属性2（普通采集方案）∷=structure//删除时structure的数据单元清为0(NULL)
	DataType_structure,
	6,
...
#if NUMmax_6014<(33+1+1)//最大普通采集方案数
	#error
#endif
...
const u8 InitData_6016_2_1[]=//1 级事件采集方案，根据通知采集指定事件数据
{
...
//  采集内容      Data
	...
	0x20, 0x22, 0x02, 0x00,
	DataType_ROAD,
	0x30, 0x0F, 0x02, 0x00,// 9电压不平衡
	0x03,
	0x20, 0x1E, 0x02, 0x00,
	0x20, 0x20, 0x02, 0x00,
	0x20, 0x22, 0x02, 0x00,//事件记录序号
//	DataType_ROAD,
//	0x30, 0x1C, 0x02, 0x00,// 18?????
//	0x03,
//	0x20, 0x1E, 0x02, 0x00,//??????
//	0x20, 0x20, 0x02, 0x00,//??????
//	0x20, 0x22, 0x02, 0x00,//??????
...
{
	DataType_unsigned,
	2,//宽带载波频段：0：1.953～11.96MHz；1： 2.441～5.615 MHz；2：0.781～2.930
	//0,
};


const u8 InitData_F209_11[]=
{
	DataType_unsigned,
	0,
...
const u8 InitData_F209_22[]=
{
	DataType_enum,
	0,//拒绝节点上报使能标志：禁止（0），使能（1）
};
