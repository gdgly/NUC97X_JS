...
#if PUBLIC_PRIVATE_NETWORKS_TEST==1 //用于电科院公转一体化测试
const u8 InitData_4520_2[]=
{
//主站通信参数表∷=array 主站通信参数
	DataType_array,
	6,
//第1个主站通信参数：：=structure 移动物联公网2G
	DataType_structure,
	8,
//运营商 enum 
//{ 
...
//第3个主站通信参数：：=structure 移动公网和移动物联公网4G
	DataType_structure,
	8,
//运营商 enum 
//{ 
...
//APN            visible-string，	
	...
	//jssdlgs.wxcb.jsapn
	18,
	'j','s','s','d','l','g','s','.','w','x','c','b','.','j','s','a','p','n',
//用户名         visible-string，
	DataType_visible_string,
	0,
//密码           visible-string，
...
//峰：8：00—12：00、17：00—21：00；平：12：00—17：00、21：00——00：00；谷：0：00——8：00
//日时段表∷=array 时段
	DataType_array,	
	5,
